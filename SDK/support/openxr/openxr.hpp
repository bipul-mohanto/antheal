...
class DispatchLoaderStatic {
   public:
    ...
    XrResult xrEnumerateInstanceExtensionProperties( const char* layerName, uint32_t propertyCapacityInput, uint32_t* propertyCountOutput, XrExtensionProperties* properties) const {
    ...
    XrResult xrEnumerateEnvironmentBlendModes( XrInstance instance, XrSystemId systemId, XrViewConfigurationType viewConfigurationType, uint32_t environmentBlendModeCapacityInput, uint32_t* environmentBlendModeCountOutput, XrEnvironmentBlendMode* environmentBlendModes) const {
    ...
    XrResult xrEnumerateViewConfigurations( XrInstance instance, XrSystemId systemId, uint32_t viewConfigurationTypeCapacityInput, uint32_t* viewConfigurationTypeCountOutput, XrViewConfigurationType* viewConfigurationTypes) const {
    ...
    XrResult xrGetViewConfigurationProperties( XrInstance instance, XrSystemId systemId, XrViewConfigurationType viewConfigurationType, XrViewConfigurationProperties* configurationProperties) const {
        return ::xrGetViewConfigurationProperties ( instance, systemId, viewConfigurationType, configurationProperties );
    }
    XrResult xrEnumerateViewConfigurationViews( XrInstance instance, XrSystemId systemId, XrViewConfigurationType viewConfigurationType, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrViewConfigurationView* views) const {
    ...
    XrResult xrEnumerateSwapchainImages( XrSwapchain swapchain, uint32_t imageCapacityInput, uint32_t* imageCountOutput, XrSwapchainImageBaseHeader* images) const {
    ...
    XrResult xrLocateViews( XrSession session, const XrViewLocateInfo* viewLocateInfo, XrViewState* viewState, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrView* views) const {
    ...
    XrResult xrEnumerateBoundSourcesForAction( XrSession session, const XrBoundSourcesForActionEnumerateInfo* enumerateInfo, uint32_t sourceCapacityInput, uint32_t* sourceCountOutput, XrPath* sources) const {
        return ::xrEnumerateBoundSourcesForAction ( session, enumerateInfo, sourceCapacityInput, sourceCountOutput, sources );
    }
    XrResult xrGetInputSourceLocalizedName( XrSession session, const XrInputSourceLocalizedNameGetInfo* getInfo, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer) const {
...
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSpatialGraphNodeTypeMSFT>
...
//! @brief Free function for retrieving the raw XrSpatialGraphNodeTypeMSFT value from a SpatialGraphNodeTypeMSFT
//! @relates SpatialGraphNodeTypeMSFT
OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSpatialGraphNodeTypeMSFT get(SpatialGraphNodeTypeMSFT const& v) {
    return static_cast<XrSpatialGraphNodeTypeMSFT>(v);
}

//! @brief Free function for retrieving the string name of a SpatialGraphNodeTypeMSFT value as a const char *
//! @relates SpatialGraphNodeTypeMSFT
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR const char* to_string_literal(SpatialGraphNodeTypeMSFT value) {
    switch (value) {
...
//! @brief Free function for retrieving the string name of a SpatialGraphNodeTypeMSFT value as a std::string
//! @relates SpatialGraphNodeTypeMSFT
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR std::string to_string(SpatialGraphNodeTypeMSFT value) {
    return {to_string_literal(value)};
}
...
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandEXT>
...
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandJointEXT>
...
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandJointSetEXT>
...
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandPoseTypeMSFT>
...
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrOverlaySessionCreateFlagsEXTX>
enum class OverlaySessionCreateFlagBitsEXTX : XrFlags64 {
    ...
    AllBits = 0
              | XR_OVERLAY_SESSION_CREATE_RELAXED_DISPLAY_TIME_BIT_EXTX
};
...
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrOverlayMainSessionFlagsEXTX>
...
//! @relates Result
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Result lhs, int rhs) { return get(lhs)<rhs; }

//! @brief `<` comparison between integer and Result, for compatibility with the XR_ function-type macros and XrResult.
//! @relates Result
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(int lhs, Result rhs) { return lhs<get(rhs); }
...
//! @brief Exception class associated with the Result::ErrorGraphicsRequirementsCallMissing aka XR_ERROR_GRAPHICS_REQUIREMENTS_CALL_MISSING result code.
...
#endif  // XR_MSFT_spatial_anchor
#ifdef XR_MSFT_secondary_view_configuration
//! @brief Exception class associated with the Result::ErrorSecondaryViewConfigurationTypeNotEnabledMSFT aka XR_ERROR_SECONDARY_VIEW_CONFIGURATION_TYPE_NOT_ENABLED_MSFT result code.
...
Result getInstanceProcAddr (
    const char* name, PFN_xrVoidFunction* function, Dispatch&& d = Dispatch{}) const;
 ...
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetInstanceProcAddr>
 */    template <typename Dispatch = DispatchLoaderStatic>
    ResultValueType<void>::type getInstanceProcAddr (
        const char* name, PFN_xrVoidFunction* function, Dispatch&& d = Dispatch{}) const;
 ...
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyInstance>
 */    template <typename Dispatch = DispatchLoaderStatic>
    ResultValueType<void>::type destroy (
        Dispatch&& d = Dispatch{}) const;
...
Result resultToString (
    Result value, char buffer[XR_MAX_RESULT_STRING_SIZE], Dispatch&& d = Dispatch{}) const;
 ...
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrResultToString>
 */    template <typename Dispatch = DispatchLoaderStatic>
    ResultValueType<void>::type resultToString (
        Result value, char buffer[XR_MAX_RESULT_STRING_SIZE], Dispatch&& d = Dispatch{}) const;
...
Result structureTypeToString (
    StructureType value, char buffer[XR_MAX_STRUCTURE_NAME_SIZE], Dispatch&& d = Dispatch{}) const;
 ...
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrStructureTypeToString>
 */    template <typename Dispatch = DispatchLoaderStatic>
    ResultValueType<void>::type structureTypeToString (
        StructureType value, char buffer[XR_MAX_STRUCTURE_NAME_SIZE], Dispatch&& d = Dispatch{}) const;
 ...
 */template <typename Dispatch = DispatchLoaderStatic>
Result getSystem (
    const SystemGetInfo& getInfo, const SystemId& systemId, Dispatch&& d = Dispatch{}) const;
...
Result getSystemProperties (
    const SystemId& systemId, SystemProperties& properties, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<SystemProperties>::type getSystemProperties (
        const SystemId& systemId, Dispatch&& d = Dispatch{}) const;
...
Result enumerateEnvironmentBlendModes (
    const SystemId& systemId, ViewConfigurationType viewConfigurationType, uint32_t environmentBlendModeCapacityInput, uint32_t* environmentBlendModeCountOutput, XrEnvironmentBlendMode* environmentBlendModes, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Allocator = std::allocator<EnvironmentBlendMode>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<EnvironmentBlendMode, Allocator>>::type enumerateEnvironmentBlendModes (
        const SystemId& systemId, ViewConfigurationType viewConfigurationType, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Allocator = std::allocator<EnvironmentBlendMode>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<EnvironmentBlendMode, Allocator>>::type enumerateEnvironmentBlendModes (
        const SystemId& systemId, ViewConfigurationType viewConfigurationType, Allocator const& vectorAllocator, Dispatch&& d) const;
...
Result enumerateViewConfigurations (
    const SystemId& systemId, uint32_t viewConfigurationTypeCapacityInput, uint32_t* viewConfigurationTypeCountOutput, XrViewConfigurationType* viewConfigurationTypes, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Allocator = std::allocator<ViewConfigurationType>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<ViewConfigurationType, Allocator>>::type enumerateViewConfigurations (
        const SystemId& systemId, Allocator const& vectorAllocator, Dispatch&& d) const;
...
Result getViewConfigurationProperties (
    const SystemId& systemId, ViewConfigurationType viewConfigurationType, ViewConfigurationProperties& configurationProperties, Dispatch&& d = Dispatch{}) const;
...
Result enumerateViewConfigurationViews (
    const SystemId& systemId, ViewConfigurationType viewConfigurationType, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrViewConfigurationView* views, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Allocator = std::allocator<ViewConfigurationView>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<ViewConfigurationView, Allocator>>::type enumerateViewConfigurationViews (
        const SystemId& systemId, ViewConfigurationType viewConfigurationType, Dispatch&& d = Dispatch{}) const;
 ...
 */template <typename Dispatch = DispatchLoaderStatic>
Result stringToPath (
    const char* pathString, const Path& path, Dispatch&& d = Dispatch{}) const;
 ...
 */template <typename Dispatch = DispatchLoaderStatic>
Result pathToString (
    const Path& path, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Allocator = std::allocator<char>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<string_with_allocator<Allocator>>::type pathToString (
        const Path& path, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Allocator = std::allocator<char>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<string_with_allocator<Allocator>>::type pathToString (
        const Path& path, Allocator const& vectorAllocator, Dispatch&& d) const;
...
Result getOpenGLGraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsOpenGLKHR& graphicsRequirements, Dispatch&& d) const;
 ...
 */    template <typename Dispatch>
    typename ResultValueType<GraphicsRequirementsOpenGLKHR>::type getOpenGLGraphicsRequirementsKHR (
        const SystemId& systemId, Dispatch&& d) const;
...
Result getOpenGLESGraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsOpenGLESKHR& graphicsRequirements, Dispatch&& d) const;
...
Result getVulkanInstanceExtensionsKHR (
    const SystemId& systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d) const;
 ...
 */    template <typename Allocator = std::allocator<char>, typename Dispatch>
    typename ResultValueType<string_with_allocator<Allocator>>::type getVulkanInstanceExtensionsKHR (
        const SystemId& systemId, Dispatch&& d) const;
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Allocator = std::allocator<char>, typename Dispatch>
    typename ResultValueType<string_with_allocator<Allocator>>::type getVulkanDeviceExtensionsKHR (
        const SystemId& systemId, Dispatch&& d) const;
...
Result getVulkanGraphicsDeviceKHR (
    const SystemId& systemId, VkInstance vkInstance, VkPhysicalDevice* vkPhysicalDevice, Dispatch&& d) const;
 ...
 */    template <typename Dispatch>
    typename ResultValueType<VkPhysicalDevice>::type getVulkanGraphicsDeviceKHR (
        const SystemId& systemId, VkInstance vkInstance, Dispatch&& d) const;
...
Result getVulkanGraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsVulkanKHR& graphicsRequirements, Dispatch&& d) const;
...
Result getD3D11GraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsD3D11KHR& graphicsRequirements, Dispatch&& d) const;
...
Result getD3D12GraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsD3D12KHR& graphicsRequirements, Dispatch&& d) const;
...
Result convertWin32PerformanceCounterToTimeKHR (
    const LARGE_INTEGER* performanceCounter, const Time& time, Dispatch&& d) const;
 ...
 */    template <typename Allocator = std::allocator<ReferenceSpaceType>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<ReferenceSpaceType, Allocator>>::type enumerateReferenceSpaces (
        Dispatch&& d = Dispatch{}) const;
...
Result enumerateSwapchainFormats (
    uint32_t formatCapacityInput, uint32_t* formatCountOutput, int64_t* formats, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Allocator = std::allocator<int64_t>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<int64_t, Allocator>>::type enumerateSwapchainFormats (
        Dispatch&& d = Dispatch{}) const;
 ...
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEndSession>
 */    template <typename Dispatch = DispatchLoaderStatic>
    ResultValueType<void>::type endSession (
        Dispatch&& d = Dispatch{}) const;
 ...
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrRequestExitSession>
 */    template <typename Dispatch = DispatchLoaderStatic>
    ResultValueType<void>::type requestExitSession (
        Dispatch&& d = Dispatch{}) const;
...
Result getCurrentInteractionProfile (
    const Path& topLevelUserPath, InteractionProfileState& interactionProfile, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<InteractionProfileState>::type getCurrentInteractionProfile (
        const Path& topLevelUserPath, Dispatch&& d = Dispatch{}) const;
...
Result enumerateBoundSourcesForAction (
    const BoundSourcesForActionEnumerateInfo& enumerateInfo, uint32_t sourceCapacityInput, uint32_t* sourceCountOutput, const Path& sources, Dispatch&& d = Dispatch{}) const;
 ...
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetInputSourceLocalizedName>
 */    template <typename Allocator = std::allocator<char>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<string_with_allocator<Allocator>>::type getInputSourceLocalizedName (
...
Result applyHapticFeedback (
    const HapticActionInfo& hapticActionInfo, const XrHapticBaseHeader* hapticFeedback, Dispatch&& d = Dispatch{}) const;
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    ResultValueType<void>::type setAndroidApplicationThreadKHR (
        AndroidThreadTypeKHR threadType, uint32_t threadId, Dispatch&& d) const;
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    ResultValueType<void>::type perfSettingsSetPerformanceLevelEXT (
        PerfSettingsDomainEXT domain, PerfSettingsLevelEXT level, Dispatch&& d) const;
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    ResultValueType<void>::type sessionEndDebugUtilsLabelRegionEXT (
        Dispatch&& d) const;
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceActiveEXT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
Result setInputDeviceActiveEXT (
    const Path& interactionProfile, const Path& topLevelPath, XrBool32 isActive, Dispatch&& d) const;

#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
/*!
 * @brief xrSetInputDeviceActiveEXT wrapper - enhanced mode (hides basic wrapper unless OPENXR_HPP_DISABLE_ENHANCED_MODE defined).
 *
 * If OPENXR_HPP_NO_EXCEPTIONS is not defined:
 *
 * - Throws an appropriate exception on failure.
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    ResultValueType<void>::type setInputDeviceActiveEXT (
        const Path& interactionProfile, const Path& topLevelPath, XrBool32 isActive, Dispatch&& d) const;
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceStateBoolEXT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
Result setInputDeviceStateBoolEXT (
    const Path& topLevelPath, const Path& inputSourcePath, XrBool32 state, Dispatch&& d) const;

#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
/*!
 * @brief xrSetInputDeviceStateBoolEXT wrapper - enhanced mode (hides basic wrapper unless OPENXR_HPP_DISABLE_ENHANCED_MODE defined).
 *
 * If OPENXR_HPP_NO_EXCEPTIONS is not defined:
 *
 * - Throws an appropriate exception on failure.
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    ResultValueType<void>::type setInputDeviceStateBoolEXT (
        const Path& topLevelPath, const Path& inputSourcePath, XrBool32 state, Dispatch&& d) const;
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceStateFloatEXT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
Result setInputDeviceStateFloatEXT (
    const Path& topLevelPath, const Path& inputSourcePath, float state, Dispatch&& d) const;

#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
/*!
 * @brief xrSetInputDeviceStateFloatEXT wrapper - enhanced mode (hides basic wrapper unless OPENXR_HPP_DISABLE_ENHANCED_MODE defined).
 *
 * If OPENXR_HPP_NO_EXCEPTIONS is not defined:
 *
 * - Throws an appropriate exception on failure.
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    ResultValueType<void>::type setInputDeviceStateFloatEXT (
        const Path& topLevelPath, const Path& inputSourcePath, float state, Dispatch&& d) const;
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceStateVector2fEXT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
Result setInputDeviceStateVector2fEXT (
    const Path& topLevelPath, const Path& inputSourcePath, XrVector2f state, Dispatch&& d) const;

#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
/*!
 * @brief xrSetInputDeviceStateVector2fEXT wrapper - enhanced mode (hides basic wrapper unless OPENXR_HPP_DISABLE_ENHANCED_MODE defined).
 *
 * If OPENXR_HPP_NO_EXCEPTIONS is not defined:
 *
 * - Throws an appropriate exception on failure.
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    ResultValueType<void>::type setInputDeviceStateVector2fEXT (
        const Path& topLevelPath, const Path& inputSourcePath, XrVector2f state, Dispatch&& d) const;
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceLocationEXT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
Result setInputDeviceLocationEXT (
    const Path& topLevelPath, const Path& inputSourcePath, Space space, XrPosef pose, Dispatch&& d) const;

#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
/*!
 * @brief xrSetInputDeviceLocationEXT wrapper - enhanced mode (hides basic wrapper unless OPENXR_HPP_DISABLE_ENHANCED_MODE defined).
 *
 * If OPENXR_HPP_NO_EXCEPTIONS is not defined:
 *
 * - Throws an appropriate exception on failure.
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    ResultValueType<void>::type setInputDeviceLocationEXT (
        const Path& topLevelPath, const Path& inputSourcePath, Space space, XrPosef pose, Dispatch&& d) const;
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSpatialGraphNodeSpaceMSFT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    typename ResultValueType<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>>::type createSpatialGraphNodeSpaceUniqueMSFT (
        const SpatialGraphNodeSpaceCreateInfoMSFT& createInfo, Dispatch&& d) const;
#endif /*OPENXR_HPP_NO_SMART_HANDLE*/
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateHandTrackerEXT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    typename ResultValueType<HandTrackerEXT>::type createHandTrackerEXT (
 ...
 *
 * - Throws an appropriate exception on failure.
 * - Returns the value of type UniqueHandle<HandTrackerEXT, impl::RemoveRefConst<Dispatch>>
 *
 * If OPENXR_HPP_NO_EXCEPTIONS is defined:
 *
 * - Asserts that result is Result::Success.
 * - Returns the output of type UniqueHandle<HandTrackerEXT, impl::RemoveRefConst<Dispatch>>.
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateHandTrackerEXT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    typename ResultValueType<UniqueHandle<HandTrackerEXT, impl::RemoveRefConst<Dispatch>>>::type createHandTrackerUniqueEXT (
        const HandTrackerCreateInfoEXT& createInfo, Dispatch&& d) const;
#endif /*OPENXR_HPP_NO_SMART_HANDLE*/
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
 ...
 */template <typename Dispatch = DispatchLoaderStatic>
Result locateSpace (
    Space baseSpace, const Time& time, SpaceLocation& location, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<SpaceLocation>::type locateSpace (
        Space baseSpace, const Time& time, Dispatch&& d = Dispatch{}) const;
...
Result enumerateSwapchainImages (
    uint32_t imageCapacityInput, uint32_t* imageCountOutput, XrSwapchainImageBaseHeader* images, Dispatch&& d = Dispatch{}) const;
 ...
 */    template <typename ResultItemType, typename Allocator = std::allocator<ResultItemType>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<ResultItemType, Allocator>>::type enumerateSwapchainImages (
        Dispatch&& d = Dispatch{}) const;
...
//! Should be found by argument-dependent lookup and thus not need to have the namespace specified.
//! @relates DebugUtilsMessengerEXT
OPENXR_HPP_INLINE XrDebugUtilsMessengerEXT *put(DebugUtilsMessengerEXT &v) noexcept { return v.put(); }
...
//! Should be found by argument-dependent lookup and thus not need to have the namespace specified.
//! @relates SpatialAnchorMSFT
OPENXR_HPP_INLINE XrSpatialAnchorMSFT *put(SpatialAnchorMSFT &v) noexcept { return v.put(); }
...
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandTrackerEXT>
//! @ingroup handles
class HandTrackerEXT {
   public:
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyHandTrackerEXT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
...
#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
/*!
 * @brief xrDestroyHandTrackerEXT wrapper - enhanced mode (hides basic wrapper unless OPENXR_HPP_DISABLE_ENHANCED_MODE defined).
 *
 * If OPENXR_HPP_NO_EXCEPTIONS is not defined:
 *
 * - Throws an appropriate exception on failure.
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrLocateHandJointsEXT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    typename ResultValueType<HandJointLocationsEXT>::type locateHandJointsEXT (
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateHandMeshSpaceMSFT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    typename ResultValueType<Space>::type createHandMeshSpaceMSFT (
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    typename ResultValueType<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>>::type createHandMeshSpaceUniqueMSFT (
        const HandMeshSpaceCreateInfoMSFT& createInfo, Dispatch&& d) const;
#endif /*OPENXR_HPP_NO_SMART_HANDLE*/
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
 ...
 *
 * See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrUpdateHandMeshMSFT>
 *
 * @note No default dispatch is provided as this is a non-core function,
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */template <typename Dispatch>
 ...
 * and thus requires some dynamic dispatch class (like DispatchLoaderDynamic)
 */    template <typename Dispatch>
    typename ResultValueType<HandMeshMSFT>::type updateHandMeshMSFT (
...
static_assert(sizeof(HandTrackerEXT) == sizeof(XrHandTrackerEXT), "raw type and wrapper have different size!");
//! @brief Free function for getting the raw XrHandTrackerEXT from HandTrackerEXT.
//!
//! Should be found via argument-dependent lookup and thus not need explicit namespace qualification.
...
//! @brief Free "put" function for clearing and getting the address of the raw XrHandTrackerEXT handle in a HandTrackerEXT (by
//! reference).
//!
//! e.g.
//! ```
...
//! Should be found by argument-dependent lookup and thus not need to have the namespace specified.
//! @relates HandTrackerEXT
OPENXR_HPP_INLINE XrHandTrackerEXT *put(HandTrackerEXT &v) noexcept { return v.put(); }
...
template <>
struct cpp_type<ObjectType::HandTrackerEXT> {
    using type = HandTrackerEXT;
};
} // namespace traits
...
Result enumerateApiLayerProperties (
    uint32_t propertyCapacityInput, uint32_t* propertyCountOutput, XrApiLayerProperties* properties, Dispatch&& d = Dispatch{}) ;
 ...
 */    template <typename Allocator = std::allocator<ApiLayerProperties>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<ApiLayerProperties, Allocator>>::type enumerateApiLayerProperties (
        Dispatch&& d = Dispatch{}) ;
...
Result enumerateInstanceExtensionProperties (
    const char* layerName, uint32_t propertyCapacityInput, uint32_t* propertyCountOutput, XrExtensionProperties* properties, Dispatch&& d = Dispatch{}) ;
 ...
 */    template <typename Allocator = std::allocator<ExtensionProperties>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<ExtensionProperties, Allocator>>::type enumerateInstanceExtensionProperties (
        const char* layerName, Dispatch&& d = Dispatch{}) ;
...
struct ApiLayerProperties : public traits::TypedStructTraits<ApiLayerProperties> {
   ...
   public:
    ...
    //! @relates ApiLayerProperties
    OPENXR_HPP_INLINE XrApiLayerProperties* put(ApiLayerProperties &h) { return &(h.operator XrApiLayerProperties&()); }
...
struct ExtensionProperties : public traits::TypedStructTraits<ExtensionProperties> {
   ...
   public:
    ...
    //! @relates ExtensionProperties
    OPENXR_HPP_INLINE XrExtensionProperties* put(ExtensionProperties &h) { return &(h.operator XrExtensionProperties&()); }
    ...
    struct ApplicationInfo {
        // ctor
              ApplicationInfo (
                  const char* applicationName_ = nullptr,
    ...
    //! @relates ApplicationInfo
    OPENXR_HPP_INLINE XrApplicationInfo* put(ApplicationInfo &h) { return &(h.operator XrApplicationInfo&()); }
...
struct InstanceCreateInfo : public traits::TypedStructTraits<InstanceCreateInfo> {
   ...
   public:
        // ctor
              InstanceCreateInfo (
                  const InstanceCreateFlags& createFlags_ = {},
    ...
    //! @relates InstanceCreateInfo
    OPENXR_HPP_INLINE XrInstanceCreateInfo* put(InstanceCreateInfo &h) { return &(h.operator XrInstanceCreateInfo&()); }
...
struct InstanceProperties : public traits::TypedStructTraits<InstanceProperties> {
   ...
   public:
    ...
    //! @relates InstanceProperties
    OPENXR_HPP_INLINE XrInstanceProperties* put(InstanceProperties &h) { return &(h.operator XrInstanceProperties&()); }
...
struct EventDataBuffer : public traits::TypedStructTraits<EventDataBuffer> {
   ...
   public:
    ...
    //! @relates EventDataBuffer
    OPENXR_HPP_INLINE XrEventDataBuffer* put(EventDataBuffer &h) { return &(h.operator XrEventDataBuffer&()); }
...
struct SystemGetInfo : public traits::TypedStructTraits<SystemGetInfo> {
   ...
   public:
    ...
    //! @relates SystemGetInfo
    OPENXR_HPP_INLINE XrSystemGetInfo* put(SystemGetInfo &h) { return &(h.operator XrSystemGetInfo&()); }
    ...
    struct SystemGraphicsProperties {
        // ctor
              SystemGraphicsProperties (
                  uint32_t maxSwapchainImageHeight_ = 0,
    ...
    //! @relates SystemGraphicsProperties
    OPENXR_HPP_INLINE XrSystemGraphicsProperties* put(SystemGraphicsProperties &h) { return &(h.operator XrSystemGraphicsProperties&()); }
    ...
    struct SystemTrackingProperties {
        // ctor
              SystemTrackingProperties (
                  const Bool32& orientationTracking_ = XR_FALSE,
    ...
    //! @relates SystemTrackingProperties
    OPENXR_HPP_INLINE XrSystemTrackingProperties* put(SystemTrackingProperties &h) { return &(h.operator XrSystemTrackingProperties&()); }
...
struct SystemProperties : public traits::TypedStructTraits<SystemProperties> {
   ...
   public:
    ...
    //! @relates SystemProperties
    OPENXR_HPP_INLINE XrSystemProperties* put(SystemProperties &h) { return &(h.operator XrSystemProperties&()); }
...
struct SessionCreateInfo : public traits::TypedStructTraits<SessionCreateInfo> {
   ...
   public:
        // ctor
              SessionCreateInfo (
                  const SessionCreateFlags& createFlags_ = {},
    ...
    //! @relates SessionCreateInfo
    OPENXR_HPP_INLINE XrSessionCreateInfo* put(SessionCreateInfo &h) { return &(h.operator XrSessionCreateInfo&()); }
    ...
    //! @relates Vector3f
    OPENXR_HPP_INLINE XrVector3f* put(Vector3f &h) { return &(h.operator XrVector3f&()); }
...
struct SpaceVelocity : public traits::TypedStructTraits<SpaceVelocity> {
   ...
   public:
        // ctor
              SpaceVelocity (
                  const SpaceVelocityFlags& velocityFlags_ = {},
    ...
    //! @relates SpaceVelocity
    OPENXR_HPP_INLINE XrSpaceVelocity* put(SpaceVelocity &h) { return &(h.operator XrSpaceVelocity&()); }
    ...
    //! @relates Quaternionf
    OPENXR_HPP_INLINE XrQuaternionf* put(Quaternionf &h) { return &(h.operator XrQuaternionf&()); }
...
struct ReferenceSpaceCreateInfo : public traits::TypedStructTraits<ReferenceSpaceCreateInfo> {
   ...
   public:
    ...
    //! @relates ReferenceSpaceCreateInfo
    OPENXR_HPP_INLINE XrReferenceSpaceCreateInfo* put(ReferenceSpaceCreateInfo &h) { return &(h.operator XrReferenceSpaceCreateInfo&()); }
    ...
    //! @relates Extent2Df
    OPENXR_HPP_INLINE XrExtent2Df* put(Extent2Df &h) { return &(h.operator XrExtent2Df&()); }
...
struct ActionSpaceCreateInfo : public traits::TypedStructTraits<ActionSpaceCreateInfo> {
   ...
   public:
    ...
    //! @relates ActionSpaceCreateInfo
    OPENXR_HPP_INLINE XrActionSpaceCreateInfo* put(ActionSpaceCreateInfo &h) { return &(h.operator XrActionSpaceCreateInfo&()); }
...
struct SpaceLocation : public traits::TypedStructTraits<SpaceLocation> {
   ...
   public:
        // ctor
              SpaceLocation (
                  const SpaceLocationFlags& locationFlags_ = {},
                  const Posef& pose_ = {}
                  )
            :
    ...
    //! @relates SpaceLocation
    OPENXR_HPP_INLINE XrSpaceLocation* put(SpaceLocation &h) { return &(h.operator XrSpaceLocation&()); }
...
struct ViewConfigurationProperties : public traits::TypedStructTraits<ViewConfigurationProperties> {
   ...
   public:
    ...
    //! @relates ViewConfigurationProperties
    OPENXR_HPP_INLINE XrViewConfigurationProperties* put(ViewConfigurationProperties &h) { return &(h.operator XrViewConfigurationProperties&()); }
   ...
   public:
        // ctor
              ViewConfigurationView (
                  uint32_t recommendedImageRectWidth_ = 0,
    ...
    //! @relates ViewConfigurationView
    OPENXR_HPP_INLINE XrViewConfigurationView* put(ViewConfigurationView &h) { return &(h.operator XrViewConfigurationView&()); }
...
struct SwapchainCreateInfo : public traits::TypedStructTraits<SwapchainCreateInfo> {
   ...
   public:
        // ctor
              SwapchainCreateInfo (
                  const SwapchainCreateFlags& createFlags_ = {},
    ...
    //! @relates SwapchainCreateInfo
    OPENXR_HPP_INLINE XrSwapchainCreateInfo* put(SwapchainCreateInfo &h) { return &(h.operator XrSwapchainCreateInfo&()); }
...
struct SwapchainImageAcquireInfo : public traits::TypedStructTraits<SwapchainImageAcquireInfo> {
   ...
   public:
    ...
    //! @relates SwapchainImageAcquireInfo
    OPENXR_HPP_INLINE XrSwapchainImageAcquireInfo* put(SwapchainImageAcquireInfo &h) { return &(h.operator XrSwapchainImageAcquireInfo&()); }
...
struct SwapchainImageWaitInfo : public traits::TypedStructTraits<SwapchainImageWaitInfo> {
   ...
   public:
    ...
    //! @relates SwapchainImageWaitInfo
    OPENXR_HPP_INLINE XrSwapchainImageWaitInfo* put(SwapchainImageWaitInfo &h) { return &(h.operator XrSwapchainImageWaitInfo&()); }
...
struct SwapchainImageReleaseInfo : public traits::TypedStructTraits<SwapchainImageReleaseInfo> {
   ...
   public:
    ...
    //! @relates SwapchainImageReleaseInfo
    OPENXR_HPP_INLINE XrSwapchainImageReleaseInfo* put(SwapchainImageReleaseInfo &h) { return &(h.operator XrSwapchainImageReleaseInfo&()); }
...
struct SessionBeginInfo : public traits::TypedStructTraits<SessionBeginInfo> {
   ...
   public:
    ...
    //! @relates SessionBeginInfo
    OPENXR_HPP_INLINE XrSessionBeginInfo* put(SessionBeginInfo &h) { return &(h.operator XrSessionBeginInfo&()); }
...
struct FrameWaitInfo : public traits::TypedStructTraits<FrameWaitInfo> {
   ...
   public:
    ...
    //! @relates FrameWaitInfo
    OPENXR_HPP_INLINE XrFrameWaitInfo* put(FrameWaitInfo &h) { return &(h.operator XrFrameWaitInfo&()); }
...
struct FrameState : public traits::TypedStructTraits<FrameState> {
   ...
   public:
    ...
    //! @relates FrameState
    OPENXR_HPP_INLINE XrFrameState* put(FrameState &h) { return &(h.operator XrFrameState&()); }
...
struct FrameBeginInfo : public traits::TypedStructTraits<FrameBeginInfo> {
   ...
   public:
    ...
    //! @relates FrameBeginInfo
    OPENXR_HPP_INLINE XrFrameBeginInfo* put(FrameBeginInfo &h) { return &(h.operator XrFrameBeginInfo&()); }
...
struct FrameEndInfo : public traits::TypedStructTraits<FrameEndInfo> {
   ...
   public:
    ...
    //! @relates FrameEndInfo
    OPENXR_HPP_INLINE XrFrameEndInfo* put(FrameEndInfo &h) { return &(h.operator XrFrameEndInfo&()); }
...
struct ViewLocateInfo : public traits::TypedStructTraits<ViewLocateInfo> {
   ...
   public:
    ...
    //! @relates ViewLocateInfo
    OPENXR_HPP_INLINE XrViewLocateInfo* put(ViewLocateInfo &h) { return &(h.operator XrViewLocateInfo&()); }
...
struct ViewState : public traits::TypedStructTraits<ViewState> {
   ...
   public:
        // ctor
              ViewState (
                  const ViewStateFlags& viewStateFlags_ = {}
                  )
            :
    ...
    //! @relates ViewState
    OPENXR_HPP_INLINE XrViewState* put(ViewState &h) { return &(h.operator XrViewState&()); }
...
struct ActionSetCreateInfo : public traits::TypedStructTraits<ActionSetCreateInfo> {
   ...
   public:
        // ctor
              ActionSetCreateInfo (
                  const char* actionSetName_ = nullptr,
    ...
    //! @relates ActionSetCreateInfo
    OPENXR_HPP_INLINE XrActionSetCreateInfo* put(ActionSetCreateInfo &h) { return &(h.operator XrActionSetCreateInfo&()); }
...
struct ActionCreateInfo : public traits::TypedStructTraits<ActionCreateInfo> {
   ...
   public:
        // ctor
              ActionCreateInfo (
                  const char* actionName_ = nullptr,
    ...
    //! @relates ActionCreateInfo
    OPENXR_HPP_INLINE XrActionCreateInfo* put(ActionCreateInfo &h) { return &(h.operator XrActionCreateInfo&()); }
    ...
    //! @relates ActionSuggestedBinding
    OPENXR_HPP_INLINE XrActionSuggestedBinding* put(ActionSuggestedBinding &h) { return &(h.operator XrActionSuggestedBinding&()); }
...
struct InteractionProfileSuggestedBinding : public traits::TypedStructTraits<InteractionProfileSuggestedBinding> {
   ...
   public:
    ...
    //! @relates InteractionProfileSuggestedBinding
    OPENXR_HPP_INLINE XrInteractionProfileSuggestedBinding* put(InteractionProfileSuggestedBinding &h) { return &(h.operator XrInteractionProfileSuggestedBinding&()); }
...
struct SessionActionSetsAttachInfo : public traits::TypedStructTraits<SessionActionSetsAttachInfo> {
   ...
   public:
    ...
    //! @relates SessionActionSetsAttachInfo
    OPENXR_HPP_INLINE XrSessionActionSetsAttachInfo* put(SessionActionSetsAttachInfo &h) { return &(h.operator XrSessionActionSetsAttachInfo&()); }
...
struct InteractionProfileState : public traits::TypedStructTraits<InteractionProfileState> {
   ...
   public:
    ...
    //! @relates InteractionProfileState
    OPENXR_HPP_INLINE XrInteractionProfileState* put(InteractionProfileState &h) { return &(h.operator XrInteractionProfileState&()); }
...
struct ActionStateGetInfo : public traits::TypedStructTraits<ActionStateGetInfo> {
   ...
   public:
    ...
    //! @relates ActionStateGetInfo
    OPENXR_HPP_INLINE XrActionStateGetInfo* put(ActionStateGetInfo &h) { return &(h.operator XrActionStateGetInfo&()); }
...
struct ActionStateBoolean : public traits::TypedStructTraits<ActionStateBoolean> {
   ...
   public:
        // ctor
              ActionStateBoolean (
                  const Bool32& currentState_ = XR_FALSE,
    ...
    //! @relates ActionStateBoolean
    OPENXR_HPP_INLINE XrActionStateBoolean* put(ActionStateBoolean &h) { return &(h.operator XrActionStateBoolean&()); }
...
struct ActionStateFloat : public traits::TypedStructTraits<ActionStateFloat> {
   ...
   public:
    ...
    //! @relates ActionStateFloat
    OPENXR_HPP_INLINE XrActionStateFloat* put(ActionStateFloat &h) { return &(h.operator XrActionStateFloat&()); }
    ...
    //! @relates Vector2f
    OPENXR_HPP_INLINE XrVector2f* put(Vector2f &h) { return &(h.operator XrVector2f&()); }
...
struct ActionStateVector2f : public traits::TypedStructTraits<ActionStateVector2f> {
   ...
   public:
    ...
    //! @relates ActionStateVector2f
    OPENXR_HPP_INLINE XrActionStateVector2f* put(ActionStateVector2f &h) { return &(h.operator XrActionStateVector2f&()); }
...
struct ActionStatePose : public traits::TypedStructTraits<ActionStatePose> {
   ...
   public:
    ...
    //! @relates ActionStatePose
    OPENXR_HPP_INLINE XrActionStatePose* put(ActionStatePose &h) { return &(h.operator XrActionStatePose&()); }
    ...
    //! @relates ActiveActionSet
    OPENXR_HPP_INLINE XrActiveActionSet* put(ActiveActionSet &h) { return &(h.operator XrActiveActionSet&()); }
...
struct ActionsSyncInfo : public traits::TypedStructTraits<ActionsSyncInfo> {
   ...
   public:
        // ctor
              ActionsSyncInfo (
                  uint32_t countActiveActionSets_ = 0,
    ...
    //! @relates ActionsSyncInfo
    OPENXR_HPP_INLINE XrActionsSyncInfo* put(ActionsSyncInfo &h) { return &(h.operator XrActionsSyncInfo&()); }
...
struct BoundSourcesForActionEnumerateInfo : public traits::TypedStructTraits<BoundSourcesForActionEnumerateInfo> {
   ...
   public:
    ...
    //! @relates BoundSourcesForActionEnumerateInfo
    OPENXR_HPP_INLINE XrBoundSourcesForActionEnumerateInfo* put(BoundSourcesForActionEnumerateInfo &h) { return &(h.operator XrBoundSourcesForActionEnumerateInfo&()); }
...
struct InputSourceLocalizedNameGetInfo : public traits::TypedStructTraits<InputSourceLocalizedNameGetInfo> {
   ...
   public:
    ...
    //! @relates InputSourceLocalizedNameGetInfo
    OPENXR_HPP_INLINE XrInputSourceLocalizedNameGetInfo* put(InputSourceLocalizedNameGetInfo &h) { return &(h.operator XrInputSourceLocalizedNameGetInfo&()); }
...
struct HapticActionInfo : public traits::TypedStructTraits<HapticActionInfo> {
   ...
   public:
    ...
    //! @relates HapticActionInfo
    OPENXR_HPP_INLINE XrHapticActionInfo* put(HapticActionInfo &h) { return &(h.operator XrHapticActionInfo&()); }
    ...
    //! @relates Offset2Di
    OPENXR_HPP_INLINE XrOffset2Di* put(Offset2Di &h) { return &(h.operator XrOffset2Di&()); }
    ...
    //! @relates Extent2Di
    OPENXR_HPP_INLINE XrExtent2Di* put(Extent2Di &h) { return &(h.operator XrExtent2Di&()); }
    ...
    struct Rect2Di {
        // ctor
              Rect2Di (
                  const Offset2Di& offset_ = {},
                  const Extent2Di& extent_ = {}
                  )
            :
    ...
    //! @relates Rect2Di
    OPENXR_HPP_INLINE XrRect2Di* put(Rect2Di &h) { return &(h.operator XrRect2Di&()); }
    ...
    //! @relates SwapchainSubImage
    OPENXR_HPP_INLINE XrSwapchainSubImage* put(SwapchainSubImage &h) { return &(h.operator XrSwapchainSubImage&()); }
...
struct CompositionLayerProjectionView : public traits::TypedStructTraits<CompositionLayerProjectionView> {
   ...
   public:
    ...
    //! @relates CompositionLayerProjectionView
    OPENXR_HPP_INLINE XrCompositionLayerProjectionView* put(CompositionLayerProjectionView &h) { return &(h.operator XrCompositionLayerProjectionView&()); }
...
struct CompositionLayerProjection : public CompositionLayerBaseHeader {
   ...
   public:
    ...
    //! @relates CompositionLayerProjection
    OPENXR_HPP_INLINE XrCompositionLayerProjection* put(CompositionLayerProjection &h) { return &(h.operator XrCompositionLayerProjection&()); }
...
struct CompositionLayerQuad : public CompositionLayerBaseHeader {
   ...
   public:
    ...
    //! @relates CompositionLayerQuad
    OPENXR_HPP_INLINE XrCompositionLayerQuad* put(CompositionLayerQuad &h) { return &(h.operator XrCompositionLayerQuad&()); }
...
struct EventDataEventsLost : public EventDataBaseHeader {
   ...
   public:
    ...
    //! @relates EventDataEventsLost
    OPENXR_HPP_INLINE XrEventDataEventsLost* put(EventDataEventsLost &h) { return &(h.operator XrEventDataEventsLost&()); }
...
struct EventDataInstanceLossPending : public EventDataBaseHeader {
   ...
   public:
    ...
    //! @relates EventDataInstanceLossPending
    OPENXR_HPP_INLINE XrEventDataInstanceLossPending* put(EventDataInstanceLossPending &h) { return &(h.operator XrEventDataInstanceLossPending&()); }
...
struct EventDataSessionStateChanged : public EventDataBaseHeader {
   ...
   public:
    ...
    //! @relates EventDataSessionStateChanged
    OPENXR_HPP_INLINE XrEventDataSessionStateChanged* put(EventDataSessionStateChanged &h) { return &(h.operator XrEventDataSessionStateChanged&()); }
...
struct EventDataReferenceSpaceChangePending : public EventDataBaseHeader {
   ...
   public:
    ...
    //! @relates EventDataReferenceSpaceChangePending
    OPENXR_HPP_INLINE XrEventDataReferenceSpaceChangePending* put(EventDataReferenceSpaceChangePending &h) { return &(h.operator XrEventDataReferenceSpaceChangePending&()); }
...
struct EventDataInteractionProfileChanged : public EventDataBaseHeader {
   ...
   public:
    ...
    //! @relates EventDataInteractionProfileChanged
    OPENXR_HPP_INLINE XrEventDataInteractionProfileChanged* put(EventDataInteractionProfileChanged &h) { return &(h.operator XrEventDataInteractionProfileChanged&()); }
...
struct HapticVibration : public HapticBaseHeader {
   ...
   public:
    ...
    //! @relates HapticVibration
    OPENXR_HPP_INLINE XrHapticVibration* put(HapticVibration &h) { return &(h.operator XrHapticVibration&()); }
    ...
    //! @relates Offset2Df
    OPENXR_HPP_INLINE XrOffset2Df* put(Offset2Df &h) { return &(h.operator XrOffset2Df&()); }
    ...
    struct Rect2Df {
        // ctor
              Rect2Df (
                  const Offset2Df& offset_ = {},
                  const Extent2Df& extent_ = {}
                  )
            :
    ...
    //! @relates Rect2Df
    OPENXR_HPP_INLINE XrRect2Df* put(Rect2Df &h) { return &(h.operator XrRect2Df&()); }
    ...
    //! @relates Vector4f
    OPENXR_HPP_INLINE XrVector4f* put(Vector4f &h) { return &(h.operator XrVector4f&()); }
    ...
    //! @relates Color4f
    OPENXR_HPP_INLINE XrColor4f* put(Color4f &h) { return &(h.operator XrColor4f&()); }
...
struct CompositionLayerCubeKHR : public CompositionLayerBaseHeader {
   ...
   public:
    ...
    //! @relates CompositionLayerCubeKHR
    OPENXR_HPP_INLINE XrCompositionLayerCubeKHR* put(CompositionLayerCubeKHR &h) { return &(h.operator XrCompositionLayerCubeKHR&()); }
...
struct InstanceCreateInfoAndroidKHR : public traits::TypedStructTraits<InstanceCreateInfoAndroidKHR> {
   ...
   public:
    ...
    //! @relates InstanceCreateInfoAndroidKHR
    OPENXR_HPP_INLINE XrInstanceCreateInfoAndroidKHR* put(InstanceCreateInfoAndroidKHR &h) { return &(h.operator XrInstanceCreateInfoAndroidKHR&()); }
...
struct CompositionLayerDepthInfoKHR : public traits::TypedStructTraits<CompositionLayerDepthInfoKHR> {
   ...
   public:
    ...
    //! @relates CompositionLayerDepthInfoKHR
    OPENXR_HPP_INLINE XrCompositionLayerDepthInfoKHR* put(CompositionLayerDepthInfoKHR &h) { return &(h.operator XrCompositionLayerDepthInfoKHR&()); }
...
struct VulkanSwapchainFormatListCreateInfoKHR : public traits::TypedStructTraits<VulkanSwapchainFormatListCreateInfoKHR> {
   ...
   public:
    ...
    //! @relates VulkanSwapchainFormatListCreateInfoKHR
    OPENXR_HPP_INLINE XrVulkanSwapchainFormatListCreateInfoKHR* put(VulkanSwapchainFormatListCreateInfoKHR &h) { return &(h.operator XrVulkanSwapchainFormatListCreateInfoKHR&()); }
...
struct CompositionLayerCylinderKHR : public CompositionLayerBaseHeader {
   ...
   public:
    ...
    //! @relates CompositionLayerCylinderKHR
    OPENXR_HPP_INLINE XrCompositionLayerCylinderKHR* put(CompositionLayerCylinderKHR &h) { return &(h.operator XrCompositionLayerCylinderKHR&()); }
...
struct CompositionLayerEquirectKHR : public CompositionLayerBaseHeader {
   ...
   public:
    ...
    //! @relates CompositionLayerEquirectKHR
    OPENXR_HPP_INLINE XrCompositionLayerEquirectKHR* put(CompositionLayerEquirectKHR &h) { return &(h.operator XrCompositionLayerEquirectKHR&()); }
...
struct GraphicsBindingOpenGLWin32KHR : public traits::TypedStructTraits<GraphicsBindingOpenGLWin32KHR> {
   ...
   public:
    ...
    //! @relates GraphicsBindingOpenGLWin32KHR
    OPENXR_HPP_INLINE XrGraphicsBindingOpenGLWin32KHR* put(GraphicsBindingOpenGLWin32KHR &h) { return &(h.operator XrGraphicsBindingOpenGLWin32KHR&()); }
...
struct GraphicsBindingOpenGLXlibKHR : public traits::TypedStructTraits<GraphicsBindingOpenGLXlibKHR> {
   ...
   public:
    ...
    //! @relates GraphicsBindingOpenGLXlibKHR
    OPENXR_HPP_INLINE XrGraphicsBindingOpenGLXlibKHR* put(GraphicsBindingOpenGLXlibKHR &h) { return &(h.operator XrGraphicsBindingOpenGLXlibKHR&()); }
...
struct GraphicsBindingOpenGLXcbKHR : public traits::TypedStructTraits<GraphicsBindingOpenGLXcbKHR> {
   ...
   public:
    ...
    //! @relates GraphicsBindingOpenGLXcbKHR
    OPENXR_HPP_INLINE XrGraphicsBindingOpenGLXcbKHR* put(GraphicsBindingOpenGLXcbKHR &h) { return &(h.operator XrGraphicsBindingOpenGLXcbKHR&()); }
...
struct GraphicsBindingOpenGLWaylandKHR : public traits::TypedStructTraits<GraphicsBindingOpenGLWaylandKHR> {
   ...
   public:
    ...
    //! @relates GraphicsBindingOpenGLWaylandKHR
    OPENXR_HPP_INLINE XrGraphicsBindingOpenGLWaylandKHR* put(GraphicsBindingOpenGLWaylandKHR &h) { return &(h.operator XrGraphicsBindingOpenGLWaylandKHR&()); }
...
struct SwapchainImageOpenGLKHR : public SwapchainImageBaseHeader {
   ...
   public:
    ...
    //! @relates SwapchainImageOpenGLKHR
    OPENXR_HPP_INLINE XrSwapchainImageOpenGLKHR* put(SwapchainImageOpenGLKHR &h) { return &(h.operator XrSwapchainImageOpenGLKHR&()); }
   ...
   public:
        // ctor
              GraphicsRequirementsOpenGLKHR (
                  const Version& minApiVersionSupported_ = {},
    ...
    //! @relates GraphicsRequirementsOpenGLKHR
    OPENXR_HPP_INLINE XrGraphicsRequirementsOpenGLKHR* put(GraphicsRequirementsOpenGLKHR &h) { return &(h.operator XrGraphicsRequirementsOpenGLKHR&()); }
...
struct GraphicsBindingOpenGLESAndroidKHR : public traits::TypedStructTraits<GraphicsBindingOpenGLESAndroidKHR> {
   ...
   public:
    ...
    //! @relates GraphicsBindingOpenGLESAndroidKHR
    OPENXR_HPP_INLINE XrGraphicsBindingOpenGLESAndroidKHR* put(GraphicsBindingOpenGLESAndroidKHR &h) { return &(h.operator XrGraphicsBindingOpenGLESAndroidKHR&()); }
...
struct SwapchainImageOpenGLESKHR : public SwapchainImageBaseHeader {
   ...
   public:
    ...
    //! @relates SwapchainImageOpenGLESKHR
    OPENXR_HPP_INLINE XrSwapchainImageOpenGLESKHR* put(SwapchainImageOpenGLESKHR &h) { return &(h.operator XrSwapchainImageOpenGLESKHR&()); }
...
struct GraphicsRequirementsOpenGLESKHR : public traits::TypedStructTraits<GraphicsRequirementsOpenGLESKHR> {
   ...
   public:
    ...
    //! @relates GraphicsRequirementsOpenGLESKHR
    OPENXR_HPP_INLINE XrGraphicsRequirementsOpenGLESKHR* put(GraphicsRequirementsOpenGLESKHR &h) { return &(h.operator XrGraphicsRequirementsOpenGLESKHR&()); }
...
struct GraphicsBindingVulkanKHR : public traits::TypedStructTraits<GraphicsBindingVulkanKHR> {
   ...
   public:
    ...
    //! @relates GraphicsBindingVulkanKHR
    OPENXR_HPP_INLINE XrGraphicsBindingVulkanKHR* put(GraphicsBindingVulkanKHR &h) { return &(h.operator XrGraphicsBindingVulkanKHR&()); }
...
struct SwapchainImageVulkanKHR : public SwapchainImageBaseHeader {
   ...
   public:
    ...
    //! @relates SwapchainImageVulkanKHR
    OPENXR_HPP_INLINE XrSwapchainImageVulkanKHR* put(SwapchainImageVulkanKHR &h) { return &(h.operator XrSwapchainImageVulkanKHR&()); }
...
struct GraphicsRequirementsVulkanKHR : public traits::TypedStructTraits<GraphicsRequirementsVulkanKHR> {
   ...
   public:
    ...
    //! @relates GraphicsRequirementsVulkanKHR
    OPENXR_HPP_INLINE XrGraphicsRequirementsVulkanKHR* put(GraphicsRequirementsVulkanKHR &h) { return &(h.operator XrGraphicsRequirementsVulkanKHR&()); }
...
struct GraphicsBindingD3D11KHR : public traits::TypedStructTraits<GraphicsBindingD3D11KHR> {
   ...
   public:
    ...
    //! @relates GraphicsBindingD3D11KHR
    OPENXR_HPP_INLINE XrGraphicsBindingD3D11KHR* put(GraphicsBindingD3D11KHR &h) { return &(h.operator XrGraphicsBindingD3D11KHR&()); }
...
struct SwapchainImageD3D11KHR : public SwapchainImageBaseHeader {
   ...
   public:
    ...
    //! @relates SwapchainImageD3D11KHR
    OPENXR_HPP_INLINE XrSwapchainImageD3D11KHR* put(SwapchainImageD3D11KHR &h) { return &(h.operator XrSwapchainImageD3D11KHR&()); }
...
struct GraphicsRequirementsD3D11KHR : public traits::TypedStructTraits<GraphicsRequirementsD3D11KHR> {
   ...
   public:
    ...
    //! @relates GraphicsRequirementsD3D11KHR
    OPENXR_HPP_INLINE XrGraphicsRequirementsD3D11KHR* put(GraphicsRequirementsD3D11KHR &h) { return &(h.operator XrGraphicsRequirementsD3D11KHR&()); }
...
struct GraphicsBindingD3D12KHR : public traits::TypedStructTraits<GraphicsBindingD3D12KHR> {
   ...
   public:
    ...
    //! @relates GraphicsBindingD3D12KHR
    OPENXR_HPP_INLINE XrGraphicsBindingD3D12KHR* put(GraphicsBindingD3D12KHR &h) { return &(h.operator XrGraphicsBindingD3D12KHR&()); }
...
struct SwapchainImageD3D12KHR : public SwapchainImageBaseHeader {
   ...
   public:
    ...
    //! @relates SwapchainImageD3D12KHR
    OPENXR_HPP_INLINE XrSwapchainImageD3D12KHR* put(SwapchainImageD3D12KHR &h) { return &(h.operator XrSwapchainImageD3D12KHR&()); }
...
struct GraphicsRequirementsD3D12KHR : public traits::TypedStructTraits<GraphicsRequirementsD3D12KHR> {
   ...
   public:
    ...
    //! @relates GraphicsRequirementsD3D12KHR
    OPENXR_HPP_INLINE XrGraphicsRequirementsD3D12KHR* put(GraphicsRequirementsD3D12KHR &h) { return &(h.operator XrGraphicsRequirementsD3D12KHR&()); }
...
struct VisibilityMaskKHR : public traits::TypedStructTraits<VisibilityMaskKHR> {
   ...
   public:
    ...
    //! @relates VisibilityMaskKHR
    OPENXR_HPP_INLINE XrVisibilityMaskKHR* put(VisibilityMaskKHR &h) { return &(h.operator XrVisibilityMaskKHR&()); }
...
struct EventDataVisibilityMaskChangedKHR : public EventDataBaseHeader {
   ...
   public:
    ...
    //! @relates EventDataVisibilityMaskChangedKHR
    OPENXR_HPP_INLINE XrEventDataVisibilityMaskChangedKHR* put(EventDataVisibilityMaskChangedKHR &h) { return &(h.operator XrEventDataVisibilityMaskChangedKHR&()); }
...
struct EventDataPerfSettingsEXT : public EventDataBaseHeader {
   ...
   public:
    ...
    //! @relates EventDataPerfSettingsEXT
    OPENXR_HPP_INLINE XrEventDataPerfSettingsEXT* put(EventDataPerfSettingsEXT &h) { return &(h.operator XrEventDataPerfSettingsEXT&()); }
...
struct DebugUtilsObjectNameInfoEXT : public traits::TypedStructTraits<DebugUtilsObjectNameInfoEXT> {
   ...
   public:
    ...
    //! @relates DebugUtilsObjectNameInfoEXT
    OPENXR_HPP_INLINE XrDebugUtilsObjectNameInfoEXT* put(DebugUtilsObjectNameInfoEXT &h) { return &(h.operator XrDebugUtilsObjectNameInfoEXT&()); }
...
struct DebugUtilsLabelEXT : public traits::TypedStructTraits<DebugUtilsLabelEXT> {
   ...
   public:
    ...
    //! @relates DebugUtilsLabelEXT
    OPENXR_HPP_INLINE XrDebugUtilsLabelEXT* put(DebugUtilsLabelEXT &h) { return &(h.operator XrDebugUtilsLabelEXT&()); }
...
struct DebugUtilsMessengerCallbackDataEXT : public traits::TypedStructTraits<DebugUtilsMessengerCallbackDataEXT> {
   ...
   public:
    ...
    //! @relates DebugUtilsMessengerCallbackDataEXT
    OPENXR_HPP_INLINE XrDebugUtilsMessengerCallbackDataEXT* put(DebugUtilsMessengerCallbackDataEXT &h) { return &(h.operator XrDebugUtilsMessengerCallbackDataEXT&()); }
...
struct DebugUtilsMessengerCreateInfoEXT : public traits::TypedStructTraits<DebugUtilsMessengerCreateInfoEXT> {
   ...
   public:
    ...
    //! @relates DebugUtilsMessengerCreateInfoEXT
    OPENXR_HPP_INLINE XrDebugUtilsMessengerCreateInfoEXT* put(DebugUtilsMessengerCreateInfoEXT &h) { return &(h.operator XrDebugUtilsMessengerCreateInfoEXT&()); }

    #endif  // XR_EXT_debug_utils

#ifdef XR_EXT_eye_gaze_interaction
struct SystemEyeGazeInteractionPropertiesEXT : public traits::TypedStructTraits<SystemEyeGazeInteractionPropertiesEXT> {
   private:
    using Parent = traits::TypedStructTraits<SystemEyeGazeInteractionPropertiesEXT>;
   ...
   public:
    ...
    static_assert(sizeof(SystemEyeGazeInteractionPropertiesEXT) == sizeof(XrSystemEyeGazeInteractionPropertiesEXT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SystemEyeGazeInteractionPropertiesEXT const reference as a raw XrSystemEyeGazeInteractionPropertiesEXT const pointer
    //! @relates SystemEyeGazeInteractionPropertiesEXT
    OPENXR_HPP_INLINE XrSystemEyeGazeInteractionPropertiesEXT const* get(SystemEyeGazeInteractionPropertiesEXT const& h) {
        return &(h.operator XrSystemEyeGazeInteractionPropertiesEXT const&());
    }

    //! @brief Free function accessor for passing SystemEyeGazeInteractionPropertiesEXT as the address of a raw XrSystemEyeGazeInteractionPropertiesEXT
    //! @relates SystemEyeGazeInteractionPropertiesEXT
    OPENXR_HPP_INLINE XrSystemEyeGazeInteractionPropertiesEXT* put(SystemEyeGazeInteractionPropertiesEXT &h) { return &(h.operator XrSystemEyeGazeInteractionPropertiesEXT&()); }

    #endif  // XR_EXT_eye_gaze_interaction

#ifdef XR_EXT_eye_gaze_interaction
struct EyeGazeSampleTimeEXT : public traits::TypedStructTraits<EyeGazeSampleTimeEXT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(EyeGazeSampleTimeEXT) == sizeof(XrEyeGazeSampleTimeEXT), "struct and wrapper have different size!");

    //! @brief Free function accessor for EyeGazeSampleTimeEXT const reference as a raw XrEyeGazeSampleTimeEXT const pointer
    //! @relates EyeGazeSampleTimeEXT
    OPENXR_HPP_INLINE XrEyeGazeSampleTimeEXT const* get(EyeGazeSampleTimeEXT const& h) {
        return &(h.operator XrEyeGazeSampleTimeEXT const&());
    }

    //! @brief Free function accessor for passing EyeGazeSampleTimeEXT as the address of a raw XrEyeGazeSampleTimeEXT
    //! @relates EyeGazeSampleTimeEXT
    OPENXR_HPP_INLINE XrEyeGazeSampleTimeEXT* put(EyeGazeSampleTimeEXT &h) { return &(h.operator XrEyeGazeSampleTimeEXT&()); }

    #endif  // XR_EXT_eye_gaze_interaction

#ifdef XR_EXTX_overlay
struct SessionCreateInfoOverlayEXTX : public traits::TypedStructTraits<SessionCreateInfoOverlayEXTX> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(SessionCreateInfoOverlayEXTX) == sizeof(XrSessionCreateInfoOverlayEXTX), "struct and wrapper have different size!");

    //! @brief Free function accessor for SessionCreateInfoOverlayEXTX const reference as a raw XrSessionCreateInfoOverlayEXTX const pointer
    //! @relates SessionCreateInfoOverlayEXTX
    OPENXR_HPP_INLINE XrSessionCreateInfoOverlayEXTX const* get(SessionCreateInfoOverlayEXTX const& h) {
        return &(h.operator XrSessionCreateInfoOverlayEXTX const&());
    }

    //! @brief Free function accessor for passing SessionCreateInfoOverlayEXTX as the address of a raw XrSessionCreateInfoOverlayEXTX
    //! @relates SessionCreateInfoOverlayEXTX
    OPENXR_HPP_INLINE XrSessionCreateInfoOverlayEXTX* put(SessionCreateInfoOverlayEXTX &h) { return &(h.operator XrSessionCreateInfoOverlayEXTX&()); }
...
struct EventDataMainSessionVisibilityChangedEXTX : public EventDataBaseHeader {
   ...
   public:
    ...
    static_assert(sizeof(EventDataMainSessionVisibilityChangedEXTX) == sizeof(XrEventDataMainSessionVisibilityChangedEXTX), "struct and wrapper have different size!");

    //! @brief Free function accessor for EventDataMainSessionVisibilityChangedEXTX const reference as a raw XrEventDataMainSessionVisibilityChangedEXTX const pointer
    //! @relates EventDataMainSessionVisibilityChangedEXTX
    OPENXR_HPP_INLINE XrEventDataMainSessionVisibilityChangedEXTX const* get(EventDataMainSessionVisibilityChangedEXTX const& h) {
        return &(h.operator XrEventDataMainSessionVisibilityChangedEXTX const&());
    }

    //! @brief Free function accessor for passing EventDataMainSessionVisibilityChangedEXTX as the address of a raw XrEventDataMainSessionVisibilityChangedEXTX
    //! @relates EventDataMainSessionVisibilityChangedEXTX
    OPENXR_HPP_INLINE XrEventDataMainSessionVisibilityChangedEXTX* put(EventDataMainSessionVisibilityChangedEXTX &h) { return &(h.operator XrEventDataMainSessionVisibilityChangedEXTX&()); }
...
struct SpatialAnchorCreateInfoMSFT : public traits::TypedStructTraits<SpatialAnchorCreateInfoMSFT> {
   ...
   public:
    ...
    //! @relates SpatialAnchorCreateInfoMSFT
    OPENXR_HPP_INLINE XrSpatialAnchorCreateInfoMSFT* put(SpatialAnchorCreateInfoMSFT &h) { return &(h.operator XrSpatialAnchorCreateInfoMSFT&()); }
   ...
   public:
        // ctor
              SpatialAnchorSpaceCreateInfoMSFT (
                  const SpatialAnchorMSFT& anchor_ = {},
    ...
    //! @relates SpatialAnchorSpaceCreateInfoMSFT
    OPENXR_HPP_INLINE XrSpatialAnchorSpaceCreateInfoMSFT* put(SpatialAnchorSpaceCreateInfoMSFT &h) { return &(h.operator XrSpatialAnchorSpaceCreateInfoMSFT&()); }
...
struct ViewConfigurationDepthRangeEXT : public traits::TypedStructTraits<ViewConfigurationDepthRangeEXT> {
   ...
   public:
    ...
    //! @relates ViewConfigurationDepthRangeEXT
    OPENXR_HPP_INLINE XrViewConfigurationDepthRangeEXT* put(ViewConfigurationDepthRangeEXT &h) { return &(h.operator XrViewConfigurationDepthRangeEXT&()); }

    #endif  // XR_EXT_view_configuration_depth_range

#ifdef XR_MNDX_egl_enable
#if defined(XR_USE_PLATFORM_EGL)
struct GraphicsBindingEGLMNDX : public traits::TypedStructTraits<GraphicsBindingEGLMNDX> {
   private:
   ...
   public:
        // ctor
              GraphicsBindingEGLMNDX (
                  PFNEGLGETPROCADDRESSPROC getProcAddress_ = {},
                  EGLDisplay display_ = {},
                  EGLConfig config_ = {},
                  EGLContext context_ = {}
                  )
    ...
    static_assert(sizeof(GraphicsBindingEGLMNDX) == sizeof(XrGraphicsBindingEGLMNDX), "struct and wrapper have different size!");

    //! @brief Free function accessor for GraphicsBindingEGLMNDX const reference as a raw XrGraphicsBindingEGLMNDX const pointer
    //! @relates GraphicsBindingEGLMNDX
    OPENXR_HPP_INLINE XrGraphicsBindingEGLMNDX const* get(GraphicsBindingEGLMNDX const& h) {
        return &(h.operator XrGraphicsBindingEGLMNDX const&());
    }

    //! @brief Free function accessor for passing GraphicsBindingEGLMNDX as the address of a raw XrGraphicsBindingEGLMNDX
    //! @relates GraphicsBindingEGLMNDX
    OPENXR_HPP_INLINE XrGraphicsBindingEGLMNDX* put(GraphicsBindingEGLMNDX &h) { return &(h.operator XrGraphicsBindingEGLMNDX&()); }

    #endif // defined(XR_USE_PLATFORM_EGL)
#endif  // XR_MNDX_egl_enable

#ifdef XR_MSFT_spatial_graph_bridge
struct SpatialGraphNodeSpaceCreateInfoMSFT : public traits::TypedStructTraits<SpatialGraphNodeSpaceCreateInfoMSFT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(SpatialGraphNodeSpaceCreateInfoMSFT) == sizeof(XrSpatialGraphNodeSpaceCreateInfoMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SpatialGraphNodeSpaceCreateInfoMSFT const reference as a raw XrSpatialGraphNodeSpaceCreateInfoMSFT const pointer
    //! @relates SpatialGraphNodeSpaceCreateInfoMSFT
    OPENXR_HPP_INLINE XrSpatialGraphNodeSpaceCreateInfoMSFT const* get(SpatialGraphNodeSpaceCreateInfoMSFT const& h) {
        return &(h.operator XrSpatialGraphNodeSpaceCreateInfoMSFT const&());
    }

    //! @brief Free function accessor for passing SpatialGraphNodeSpaceCreateInfoMSFT as the address of a raw XrSpatialGraphNodeSpaceCreateInfoMSFT
    //! @relates SpatialGraphNodeSpaceCreateInfoMSFT
    OPENXR_HPP_INLINE XrSpatialGraphNodeSpaceCreateInfoMSFT* put(SpatialGraphNodeSpaceCreateInfoMSFT &h) { return &(h.operator XrSpatialGraphNodeSpaceCreateInfoMSFT&()); }

    #endif  // XR_MSFT_spatial_graph_bridge

#ifdef XR_EXT_hand_tracking
struct SystemHandTrackingPropertiesEXT : public traits::TypedStructTraits<SystemHandTrackingPropertiesEXT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(SystemHandTrackingPropertiesEXT) == sizeof(XrSystemHandTrackingPropertiesEXT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SystemHandTrackingPropertiesEXT const reference as a raw XrSystemHandTrackingPropertiesEXT const pointer
    //! @relates SystemHandTrackingPropertiesEXT
    OPENXR_HPP_INLINE XrSystemHandTrackingPropertiesEXT const* get(SystemHandTrackingPropertiesEXT const& h) {
        return &(h.operator XrSystemHandTrackingPropertiesEXT const&());
    }

    //! @brief Free function accessor for passing SystemHandTrackingPropertiesEXT as the address of a raw XrSystemHandTrackingPropertiesEXT
    //! @relates SystemHandTrackingPropertiesEXT
    OPENXR_HPP_INLINE XrSystemHandTrackingPropertiesEXT* put(SystemHandTrackingPropertiesEXT &h) { return &(h.operator XrSystemHandTrackingPropertiesEXT&()); }

    #endif  // XR_EXT_hand_tracking

#ifdef XR_EXT_hand_tracking
struct HandTrackerCreateInfoEXT : public traits::TypedStructTraits<HandTrackerCreateInfoEXT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(HandTrackerCreateInfoEXT) == sizeof(XrHandTrackerCreateInfoEXT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandTrackerCreateInfoEXT const reference as a raw XrHandTrackerCreateInfoEXT const pointer
    //! @relates HandTrackerCreateInfoEXT
    OPENXR_HPP_INLINE XrHandTrackerCreateInfoEXT const* get(HandTrackerCreateInfoEXT const& h) {
        return &(h.operator XrHandTrackerCreateInfoEXT const&());
    }

    //! @brief Free function accessor for passing HandTrackerCreateInfoEXT as the address of a raw XrHandTrackerCreateInfoEXT
    //! @relates HandTrackerCreateInfoEXT
    OPENXR_HPP_INLINE XrHandTrackerCreateInfoEXT* put(HandTrackerCreateInfoEXT &h) { return &(h.operator XrHandTrackerCreateInfoEXT&()); }

    #endif  // XR_EXT_hand_tracking

#ifdef XR_EXT_hand_tracking
struct HandJointsLocateInfoEXT : public traits::TypedStructTraits<HandJointsLocateInfoEXT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(HandJointsLocateInfoEXT) == sizeof(XrHandJointsLocateInfoEXT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandJointsLocateInfoEXT const reference as a raw XrHandJointsLocateInfoEXT const pointer
    //! @relates HandJointsLocateInfoEXT
    OPENXR_HPP_INLINE XrHandJointsLocateInfoEXT const* get(HandJointsLocateInfoEXT const& h) {
        return &(h.operator XrHandJointsLocateInfoEXT const&());
    }

    //! @brief Free function accessor for passing HandJointsLocateInfoEXT as the address of a raw XrHandJointsLocateInfoEXT
    //! @relates HandJointsLocateInfoEXT
    OPENXR_HPP_INLINE XrHandJointsLocateInfoEXT* put(HandJointsLocateInfoEXT &h) { return &(h.operator XrHandJointsLocateInfoEXT&()); }
    ...
    static_assert(sizeof(HandJointLocationEXT) == sizeof(XrHandJointLocationEXT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandJointLocationEXT const reference as a raw XrHandJointLocationEXT const pointer
    //! @relates HandJointLocationEXT
    OPENXR_HPP_INLINE XrHandJointLocationEXT const* get(HandJointLocationEXT const& h) {
        return &(h.operator XrHandJointLocationEXT const&());
    }

    //! @brief Free function accessor for passing HandJointLocationEXT as the address of a raw XrHandJointLocationEXT
    //! @relates HandJointLocationEXT
    OPENXR_HPP_INLINE XrHandJointLocationEXT* put(HandJointLocationEXT &h) { return &(h.operator XrHandJointLocationEXT&()); }
    ...
    static_assert(sizeof(HandJointVelocityEXT) == sizeof(XrHandJointVelocityEXT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandJointVelocityEXT const reference as a raw XrHandJointVelocityEXT const pointer
    //! @relates HandJointVelocityEXT
    OPENXR_HPP_INLINE XrHandJointVelocityEXT const* get(HandJointVelocityEXT const& h) {
        return &(h.operator XrHandJointVelocityEXT const&());
    }

    //! @brief Free function accessor for passing HandJointVelocityEXT as the address of a raw XrHandJointVelocityEXT
    //! @relates HandJointVelocityEXT
    OPENXR_HPP_INLINE XrHandJointVelocityEXT* put(HandJointVelocityEXT &h) { return &(h.operator XrHandJointVelocityEXT&()); }

    #endif  // XR_EXT_hand_tracking

#ifdef XR_EXT_hand_tracking
struct HandJointLocationsEXT : public traits::TypedStructTraits<HandJointLocationsEXT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(HandJointLocationsEXT) == sizeof(XrHandJointLocationsEXT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandJointLocationsEXT const reference as a raw XrHandJointLocationsEXT const pointer
    //! @relates HandJointLocationsEXT
    OPENXR_HPP_INLINE XrHandJointLocationsEXT const* get(HandJointLocationsEXT const& h) {
        return &(h.operator XrHandJointLocationsEXT const&());
    }

    //! @brief Free function accessor for passing HandJointLocationsEXT as the address of a raw XrHandJointLocationsEXT
    //! @relates HandJointLocationsEXT
    OPENXR_HPP_INLINE XrHandJointLocationsEXT* put(HandJointLocationsEXT &h) { return &(h.operator XrHandJointLocationsEXT&()); }

    #endif  // XR_EXT_hand_tracking

#ifdef XR_EXT_hand_tracking
struct HandJointVelocitiesEXT : public traits::TypedStructTraits<HandJointVelocitiesEXT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(HandJointVelocitiesEXT) == sizeof(XrHandJointVelocitiesEXT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandJointVelocitiesEXT const reference as a raw XrHandJointVelocitiesEXT const pointer
    //! @relates HandJointVelocitiesEXT
    OPENXR_HPP_INLINE XrHandJointVelocitiesEXT const* get(HandJointVelocitiesEXT const& h) {
        return &(h.operator XrHandJointVelocitiesEXT const&());
    }

    //! @brief Free function accessor for passing HandJointVelocitiesEXT as the address of a raw XrHandJointVelocitiesEXT
    //! @relates HandJointVelocitiesEXT
    OPENXR_HPP_INLINE XrHandJointVelocitiesEXT* put(HandJointVelocitiesEXT &h) { return &(h.operator XrHandJointVelocitiesEXT&()); }

    #endif  // XR_EXT_hand_tracking

#ifdef XR_MSFT_hand_tracking_mesh
struct SystemHandTrackingMeshPropertiesMSFT : public traits::TypedStructTraits<SystemHandTrackingMeshPropertiesMSFT> {
   private:
    using Parent = traits::TypedStructTraits<SystemHandTrackingMeshPropertiesMSFT>;

   public:
        // ctor
              SystemHandTrackingMeshPropertiesMSFT (
                  const Bool32& supportsHandTrackingMesh_ = XR_FALSE,
                  uint32_t maxHandMeshIndexCount_ = 0,
                  uint32_t maxHandMeshVertexCount_ = 0
                  )
            :
    ...
    static_assert(sizeof(SystemHandTrackingMeshPropertiesMSFT) == sizeof(XrSystemHandTrackingMeshPropertiesMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SystemHandTrackingMeshPropertiesMSFT const reference as a raw XrSystemHandTrackingMeshPropertiesMSFT const pointer
    //! @relates SystemHandTrackingMeshPropertiesMSFT
    OPENXR_HPP_INLINE XrSystemHandTrackingMeshPropertiesMSFT const* get(SystemHandTrackingMeshPropertiesMSFT const& h) {
        return &(h.operator XrSystemHandTrackingMeshPropertiesMSFT const&());
    }

    //! @brief Free function accessor for passing SystemHandTrackingMeshPropertiesMSFT as the address of a raw XrSystemHandTrackingMeshPropertiesMSFT
    //! @relates SystemHandTrackingMeshPropertiesMSFT
    OPENXR_HPP_INLINE XrSystemHandTrackingMeshPropertiesMSFT* put(SystemHandTrackingMeshPropertiesMSFT &h) { return &(h.operator XrSystemHandTrackingMeshPropertiesMSFT&()); }

    #endif  // XR_MSFT_hand_tracking_mesh

#ifdef XR_MSFT_hand_tracking_mesh
struct HandMeshSpaceCreateInfoMSFT : public traits::TypedStructTraits<HandMeshSpaceCreateInfoMSFT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(HandMeshSpaceCreateInfoMSFT) == sizeof(XrHandMeshSpaceCreateInfoMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandMeshSpaceCreateInfoMSFT const reference as a raw XrHandMeshSpaceCreateInfoMSFT const pointer
    //! @relates HandMeshSpaceCreateInfoMSFT
    OPENXR_HPP_INLINE XrHandMeshSpaceCreateInfoMSFT const* get(HandMeshSpaceCreateInfoMSFT const& h) {
        return &(h.operator XrHandMeshSpaceCreateInfoMSFT const&());
    }

    //! @brief Free function accessor for passing HandMeshSpaceCreateInfoMSFT as the address of a raw XrHandMeshSpaceCreateInfoMSFT
    //! @relates HandMeshSpaceCreateInfoMSFT
    OPENXR_HPP_INLINE XrHandMeshSpaceCreateInfoMSFT* put(HandMeshSpaceCreateInfoMSFT &h) { return &(h.operator XrHandMeshSpaceCreateInfoMSFT&()); }

    #endif  // XR_MSFT_hand_tracking_mesh

#ifdef XR_MSFT_hand_tracking_mesh
struct HandMeshUpdateInfoMSFT : public traits::TypedStructTraits<HandMeshUpdateInfoMSFT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(HandMeshUpdateInfoMSFT) == sizeof(XrHandMeshUpdateInfoMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandMeshUpdateInfoMSFT const reference as a raw XrHandMeshUpdateInfoMSFT const pointer
    //! @relates HandMeshUpdateInfoMSFT
    OPENXR_HPP_INLINE XrHandMeshUpdateInfoMSFT const* get(HandMeshUpdateInfoMSFT const& h) {
        return &(h.operator XrHandMeshUpdateInfoMSFT const&());
    }

    //! @brief Free function accessor for passing HandMeshUpdateInfoMSFT as the address of a raw XrHandMeshUpdateInfoMSFT
    //! @relates HandMeshUpdateInfoMSFT
    OPENXR_HPP_INLINE XrHandMeshUpdateInfoMSFT* put(HandMeshUpdateInfoMSFT &h) { return &(h.operator XrHandMeshUpdateInfoMSFT&()); }
    ...
    static_assert(sizeof(HandMeshIndexBufferMSFT) == sizeof(XrHandMeshIndexBufferMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandMeshIndexBufferMSFT const reference as a raw XrHandMeshIndexBufferMSFT const pointer
    //! @relates HandMeshIndexBufferMSFT
    OPENXR_HPP_INLINE XrHandMeshIndexBufferMSFT const* get(HandMeshIndexBufferMSFT const& h) {
        return &(h.operator XrHandMeshIndexBufferMSFT const&());
    }

    //! @brief Free function accessor for passing HandMeshIndexBufferMSFT as the address of a raw XrHandMeshIndexBufferMSFT
    //! @relates HandMeshIndexBufferMSFT
    OPENXR_HPP_INLINE XrHandMeshIndexBufferMSFT* put(HandMeshIndexBufferMSFT &h) { return &(h.operator XrHandMeshIndexBufferMSFT&()); }
    ...
    static_assert(sizeof(HandMeshVertexMSFT) == sizeof(XrHandMeshVertexMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandMeshVertexMSFT const reference as a raw XrHandMeshVertexMSFT const pointer
    ...
    //! @brief Free function accessor for passing HandMeshVertexMSFT as the address of a raw XrHandMeshVertexMSFT
    //! @relates HandMeshVertexMSFT
    OPENXR_HPP_INLINE XrHandMeshVertexMSFT* put(HandMeshVertexMSFT &h) { return &(h.operator XrHandMeshVertexMSFT&()); }
    ...
    static_assert(sizeof(HandMeshVertexBufferMSFT) == sizeof(XrHandMeshVertexBufferMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandMeshVertexBufferMSFT const reference as a raw XrHandMeshVertexBufferMSFT const pointer
    //! @relates HandMeshVertexBufferMSFT
    OPENXR_HPP_INLINE XrHandMeshVertexBufferMSFT const* get(HandMeshVertexBufferMSFT const& h) {
        return &(h.operator XrHandMeshVertexBufferMSFT const&());
    }

    //! @brief Free function accessor for passing HandMeshVertexBufferMSFT as the address of a raw XrHandMeshVertexBufferMSFT
    //! @relates HandMeshVertexBufferMSFT
    OPENXR_HPP_INLINE XrHandMeshVertexBufferMSFT* put(HandMeshVertexBufferMSFT &h) { return &(h.operator XrHandMeshVertexBufferMSFT&()); }
   ...
   public:
        // ctor
            ...
            :
              ...
              isActive {isActive_} ,
              indexBufferChanged {indexBufferChanged_} ,
              vertexBufferChanged {vertexBufferChanged_} ,
    ...
    static_assert(sizeof(HandMeshMSFT) == sizeof(XrHandMeshMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandMeshMSFT const reference as a raw XrHandMeshMSFT const pointer
    ...
    //! @brief Free function accessor for passing HandMeshMSFT as the address of a raw XrHandMeshMSFT
    //! @relates HandMeshMSFT
    OPENXR_HPP_INLINE XrHandMeshMSFT* put(HandMeshMSFT &h) { return &(h.operator XrHandMeshMSFT&()); }

    #endif  // XR_MSFT_hand_tracking_mesh

#ifdef XR_MSFT_hand_tracking_mesh
struct HandPoseTypeInfoMSFT : public traits::TypedStructTraits<HandPoseTypeInfoMSFT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(HandPoseTypeInfoMSFT) == sizeof(XrHandPoseTypeInfoMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HandPoseTypeInfoMSFT const reference as a raw XrHandPoseTypeInfoMSFT const pointer
    //! @relates HandPoseTypeInfoMSFT
    OPENXR_HPP_INLINE XrHandPoseTypeInfoMSFT const* get(HandPoseTypeInfoMSFT const& h) {
        return &(h.operator XrHandPoseTypeInfoMSFT const&());
    }

    //! @brief Free function accessor for passing HandPoseTypeInfoMSFT as the address of a raw XrHandPoseTypeInfoMSFT
    //! @relates HandPoseTypeInfoMSFT
    OPENXR_HPP_INLINE XrHandPoseTypeInfoMSFT* put(HandPoseTypeInfoMSFT &h) { return &(h.operator XrHandPoseTypeInfoMSFT&()); }

    #endif  // XR_MSFT_hand_tracking_mesh

#ifdef XR_MSFT_secondary_view_configuration
struct SecondaryViewConfigurationSessionBeginInfoMSFT : public traits::TypedStructTraits<SecondaryViewConfigurationSessionBeginInfoMSFT> {
   private:
    using Parent = traits::TypedStructTraits<SecondaryViewConfigurationSessionBeginInfoMSFT>;
   ...
   public:
    ...
    static_assert(sizeof(SecondaryViewConfigurationSessionBeginInfoMSFT) == sizeof(XrSecondaryViewConfigurationSessionBeginInfoMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SecondaryViewConfigurationSessionBeginInfoMSFT const reference as a raw XrSecondaryViewConfigurationSessionBeginInfoMSFT const pointer
    //! @relates SecondaryViewConfigurationSessionBeginInfoMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationSessionBeginInfoMSFT const* get(SecondaryViewConfigurationSessionBeginInfoMSFT const& h) {
        return &(h.operator XrSecondaryViewConfigurationSessionBeginInfoMSFT const&());
    }

    //! @brief Free function accessor for passing SecondaryViewConfigurationSessionBeginInfoMSFT as the address of a raw XrSecondaryViewConfigurationSessionBeginInfoMSFT
    //! @relates SecondaryViewConfigurationSessionBeginInfoMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationSessionBeginInfoMSFT* put(SecondaryViewConfigurationSessionBeginInfoMSFT &h) { return &(h.operator XrSecondaryViewConfigurationSessionBeginInfoMSFT&()); }

    #endif  // XR_MSFT_secondary_view_configuration

#ifdef XR_MSFT_secondary_view_configuration
struct SecondaryViewConfigurationStateMSFT : public traits::TypedStructTraits<SecondaryViewConfigurationStateMSFT> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(SecondaryViewConfigurationStateMSFT) == sizeof(XrSecondaryViewConfigurationStateMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SecondaryViewConfigurationStateMSFT const reference as a raw XrSecondaryViewConfigurationStateMSFT const pointer
    //! @relates SecondaryViewConfigurationStateMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationStateMSFT const* get(SecondaryViewConfigurationStateMSFT const& h) {
        return &(h.operator XrSecondaryViewConfigurationStateMSFT const&());
    }

    //! @brief Free function accessor for passing SecondaryViewConfigurationStateMSFT as the address of a raw XrSecondaryViewConfigurationStateMSFT
    //! @relates SecondaryViewConfigurationStateMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationStateMSFT* put(SecondaryViewConfigurationStateMSFT &h) { return &(h.operator XrSecondaryViewConfigurationStateMSFT&()); }

    #endif  // XR_MSFT_secondary_view_configuration

#ifdef XR_MSFT_secondary_view_configuration
struct SecondaryViewConfigurationFrameStateMSFT : public traits::TypedStructTraits<SecondaryViewConfigurationFrameStateMSFT> {
   private:
    using Parent = traits::TypedStructTraits<SecondaryViewConfigurationFrameStateMSFT>;
   ...
   public:
    ...
    static_assert(sizeof(SecondaryViewConfigurationFrameStateMSFT) == sizeof(XrSecondaryViewConfigurationFrameStateMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SecondaryViewConfigurationFrameStateMSFT const reference as a raw XrSecondaryViewConfigurationFrameStateMSFT const pointer
    //! @relates SecondaryViewConfigurationFrameStateMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationFrameStateMSFT const* get(SecondaryViewConfigurationFrameStateMSFT const& h) {
        return &(h.operator XrSecondaryViewConfigurationFrameStateMSFT const&());
    }

    //! @brief Free function accessor for passing SecondaryViewConfigurationFrameStateMSFT as the address of a raw XrSecondaryViewConfigurationFrameStateMSFT
    //! @relates SecondaryViewConfigurationFrameStateMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationFrameStateMSFT* put(SecondaryViewConfigurationFrameStateMSFT &h) { return &(h.operator XrSecondaryViewConfigurationFrameStateMSFT&()); }

    #endif  // XR_MSFT_secondary_view_configuration

#ifdef XR_MSFT_secondary_view_configuration
struct SecondaryViewConfigurationLayerInfoMSFT : public traits::TypedStructTraits<SecondaryViewConfigurationLayerInfoMSFT> {
   private:
    using Parent = traits::TypedStructTraits<SecondaryViewConfigurationLayerInfoMSFT>;
   ...
   public:
    ...
    static_assert(sizeof(SecondaryViewConfigurationLayerInfoMSFT) == sizeof(XrSecondaryViewConfigurationLayerInfoMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SecondaryViewConfigurationLayerInfoMSFT const reference as a raw XrSecondaryViewConfigurationLayerInfoMSFT const pointer
    //! @relates SecondaryViewConfigurationLayerInfoMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationLayerInfoMSFT const* get(SecondaryViewConfigurationLayerInfoMSFT const& h) {
        return &(h.operator XrSecondaryViewConfigurationLayerInfoMSFT const&());
    }

    //! @brief Free function accessor for passing SecondaryViewConfigurationLayerInfoMSFT as the address of a raw XrSecondaryViewConfigurationLayerInfoMSFT
    //! @relates SecondaryViewConfigurationLayerInfoMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationLayerInfoMSFT* put(SecondaryViewConfigurationLayerInfoMSFT &h) { return &(h.operator XrSecondaryViewConfigurationLayerInfoMSFT&()); }

    #endif  // XR_MSFT_secondary_view_configuration

#ifdef XR_MSFT_secondary_view_configuration
struct SecondaryViewConfigurationFrameEndInfoMSFT : public traits::TypedStructTraits<SecondaryViewConfigurationFrameEndInfoMSFT> {
   private:
    using Parent = traits::TypedStructTraits<SecondaryViewConfigurationFrameEndInfoMSFT>;

   public:
        // ctor
              SecondaryViewConfigurationFrameEndInfoMSFT (
                  uint32_t viewConfigurationCount_ = 0,
                  const SecondaryViewConfigurationLayerInfoMSFT* viewConfigurationLayersInfo_ = nullptr
                  )
            :
    ...
    static_assert(sizeof(SecondaryViewConfigurationFrameEndInfoMSFT) == sizeof(XrSecondaryViewConfigurationFrameEndInfoMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SecondaryViewConfigurationFrameEndInfoMSFT const reference as a raw XrSecondaryViewConfigurationFrameEndInfoMSFT const pointer
    //! @relates SecondaryViewConfigurationFrameEndInfoMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationFrameEndInfoMSFT const* get(SecondaryViewConfigurationFrameEndInfoMSFT const& h) {
        return &(h.operator XrSecondaryViewConfigurationFrameEndInfoMSFT const&());
    }

    //! @brief Free function accessor for passing SecondaryViewConfigurationFrameEndInfoMSFT as the address of a raw XrSecondaryViewConfigurationFrameEndInfoMSFT
    //! @relates SecondaryViewConfigurationFrameEndInfoMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationFrameEndInfoMSFT* put(SecondaryViewConfigurationFrameEndInfoMSFT &h) { return &(h.operator XrSecondaryViewConfigurationFrameEndInfoMSFT&()); }

    #endif  // XR_MSFT_secondary_view_configuration

#ifdef XR_MSFT_secondary_view_configuration
struct SecondaryViewConfigurationSwapchainCreateInfoMSFT : public traits::TypedStructTraits<SecondaryViewConfigurationSwapchainCreateInfoMSFT> {
   private:
    using Parent = traits::TypedStructTraits<SecondaryViewConfigurationSwapchainCreateInfoMSFT>;
   ...
   public:
    ...
    static_assert(sizeof(SecondaryViewConfigurationSwapchainCreateInfoMSFT) == sizeof(XrSecondaryViewConfigurationSwapchainCreateInfoMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for SecondaryViewConfigurationSwapchainCreateInfoMSFT const reference as a raw XrSecondaryViewConfigurationSwapchainCreateInfoMSFT const pointer
    //! @relates SecondaryViewConfigurationSwapchainCreateInfoMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationSwapchainCreateInfoMSFT const* get(SecondaryViewConfigurationSwapchainCreateInfoMSFT const& h) {
        return &(h.operator XrSecondaryViewConfigurationSwapchainCreateInfoMSFT const&());
    }

    //! @brief Free function accessor for passing SecondaryViewConfigurationSwapchainCreateInfoMSFT as the address of a raw XrSecondaryViewConfigurationSwapchainCreateInfoMSFT
    //! @relates SecondaryViewConfigurationSwapchainCreateInfoMSFT
    OPENXR_HPP_INLINE XrSecondaryViewConfigurationSwapchainCreateInfoMSFT* put(SecondaryViewConfigurationSwapchainCreateInfoMSFT &h) { return &(h.operator XrSecondaryViewConfigurationSwapchainCreateInfoMSFT&()); }

    #endif  // XR_MSFT_secondary_view_configuration

#ifdef XR_EPIC_view_configuration_fov
struct ViewConfigurationViewFovEPIC : public traits::TypedStructTraits<ViewConfigurationViewFovEPIC> {
   private:
   ...
   public:
    ...
    static_assert(sizeof(ViewConfigurationViewFovEPIC) == sizeof(XrViewConfigurationViewFovEPIC), "struct and wrapper have different size!");

    //! @brief Free function accessor for ViewConfigurationViewFovEPIC const reference as a raw XrViewConfigurationViewFovEPIC const pointer
    //! @relates ViewConfigurationViewFovEPIC
    OPENXR_HPP_INLINE XrViewConfigurationViewFovEPIC const* get(ViewConfigurationViewFovEPIC const& h) {
        return &(h.operator XrViewConfigurationViewFovEPIC const&());
    }

    //! @brief Free function accessor for passing ViewConfigurationViewFovEPIC as the address of a raw XrViewConfigurationViewFovEPIC
    //! @relates ViewConfigurationViewFovEPIC
    OPENXR_HPP_INLINE XrViewConfigurationViewFovEPIC* put(ViewConfigurationViewFovEPIC &h) { return &(h.operator XrViewConfigurationViewFovEPIC&()); }

    #endif  // XR_EPIC_view_configuration_fov

#ifdef XR_MSFT_holographic_window_attachment
#if defined(XR_USE_PLATFORM_WIN32) && defined(XR_USE_PLATFORM_WIN32)
struct HolographicWindowAttachmentMSFT : public traits::TypedStructTraits<HolographicWindowAttachmentMSFT> {
   private:
    using Parent = traits::TypedStructTraits<HolographicWindowAttachmentMSFT>;

   public:
        // ctor
              HolographicWindowAttachmentMSFT (
                  IUnknown* holographicSpace_ = nullptr,
                  IUnknown* coreWindow_ = nullptr
                  )
            :

              Parent(StructureType::HolographicWindowAttachmentMSFT
              ) ,
        ...
        operator const XrHolographicWindowAttachmentMSFT&() const { return *reinterpret_cast<const XrHolographicWindowAttachmentMSFT*>(this); }
    ...
    static_assert(sizeof(HolographicWindowAttachmentMSFT) == sizeof(XrHolographicWindowAttachmentMSFT), "struct and wrapper have different size!");

    //! @brief Free function accessor for HolographicWindowAttachmentMSFT const reference as a raw XrHolographicWindowAttachmentMSFT const pointer
    //! @relates HolographicWindowAttachmentMSFT
    OPENXR_HPP_INLINE XrHolographicWindowAttachmentMSFT const* get(HolographicWindowAttachmentMSFT const& h) {
        return &(h.operator XrHolographicWindowAttachmentMSFT const&());
    }

    //! @brief Free function accessor for passing HolographicWindowAttachmentMSFT as the address of a raw XrHolographicWindowAttachmentMSFT
    //! @relates HolographicWindowAttachmentMSFT
    OPENXR_HPP_INLINE XrHolographicWindowAttachmentMSFT* put(HolographicWindowAttachmentMSFT &h) { return &(h.operator XrHolographicWindowAttachmentMSFT&()); }

    #endif // defined(XR_USE_PLATFORM_WIN32) && defined(XR_USE_PLATFORM_WIN32)
#endif  // XR_MSFT_holographic_window_attachment

#ifdef XR_VALVE_analog_threshold
struct InteractionProfileAnalogThresholdVALVE : public traits::TypedStructTraits<InteractionProfileAnalogThresholdVALVE> {
   private:
    using Parent = traits::TypedStructTraits<InteractionProfileAnalogThresholdVALVE>;
   ...
   public:
        // ctor
              InteractionProfileAnalogThresholdVALVE (
                  const Action& action_ = {},
                  const Path& binding_ = {},
                  float onThreshold_ = 0.0f,
                  float offThreshold_ = 0.0f,
                  const HapticBaseHeader* onHaptic_ = nullptr,
                  const HapticBaseHeader* offHaptic_ = nullptr
                  )
            :
    ...
    static_assert(sizeof(InteractionProfileAnalogThresholdVALVE) == sizeof(XrInteractionProfileAnalogThresholdVALVE), "struct and wrapper have different size!");

    //! @brief Free function accessor for InteractionProfileAnalogThresholdVALVE const reference as a raw XrInteractionProfileAnalogThresholdVALVE const pointer
    //! @relates InteractionProfileAnalogThresholdVALVE
    OPENXR_HPP_INLINE XrInteractionProfileAnalogThresholdVALVE const* get(InteractionProfileAnalogThresholdVALVE const& h) {
        return &(h.operator XrInteractionProfileAnalogThresholdVALVE const&());
    }

    //! @brief Free function accessor for passing InteractionProfileAnalogThresholdVALVE as the address of a raw XrInteractionProfileAnalogThresholdVALVE
    //! @relates InteractionProfileAnalogThresholdVALVE
    OPENXR_HPP_INLINE XrInteractionProfileAnalogThresholdVALVE* put(InteractionProfileAnalogThresholdVALVE &h) { return &(h.operator XrInteractionProfileAnalogThresholdVALVE&()); }
...
class DispatchLoaderDynamic {
   public:
    ...
    static DispatchLoaderDynamic createFullyPopulated(Instance instance, PFN_xrGetInstanceProcAddr getInstanceProcAddr = nullptr) {
        ...
        dispatch.populate_("xrSetInputDeviceActiveEXT", dispatch.pfnSetInputDeviceActiveEXT);
        dispatch.populate_("xrSetInputDeviceStateBoolEXT", dispatch.pfnSetInputDeviceStateBoolEXT);
        dispatch.populate_("xrSetInputDeviceStateFloatEXT", dispatch.pfnSetInputDeviceStateFloatEXT);
        dispatch.populate_("xrSetInputDeviceStateVector2fEXT", dispatch.pfnSetInputDeviceStateVector2fEXT);
        dispatch.populate_("xrSetInputDeviceLocationEXT", dispatch.pfnSetInputDeviceLocationEXT);
        dispatch.populate_("xrCreateSpatialGraphNodeSpaceMSFT", dispatch.pfnCreateSpatialGraphNodeSpaceMSFT);
        dispatch.populate_("xrCreateHandTrackerEXT", dispatch.pfnCreateHandTrackerEXT);
        dispatch.populate_("xrDestroyHandTrackerEXT", dispatch.pfnDestroyHandTrackerEXT);
        dispatch.populate_("xrLocateHandJointsEXT", dispatch.pfnLocateHandJointsEXT);
        dispatch.populate_("xrCreateHandMeshSpaceMSFT", dispatch.pfnCreateHandMeshSpaceMSFT);
    ...
    XrResult xrGetVulkanInstanceExtensionsKHR( XrInstance instance, XrSystemId systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer) const {
    ...
    XrResult xrGetVulkanDeviceExtensionsKHR( XrInstance instance, XrSystemId systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer) const {
    ...
    XrResult xrGetVisibilityMaskKHR( XrSession session, XrViewConfigurationType viewConfigurationType, uint32_t viewIndex, XrVisibilityMaskTypeKHR visibilityMaskType, XrVisibilityMaskKHR* visibilityMask) const {
    ...
    XrResult xrThermalGetTemperatureTrendEXT( XrSession session, XrPerfSettingsDomainEXT domain, XrPerfSettingsNotificationLevelEXT* notificationLevel, float* tempHeadroom, float* tempSlope) const {
    ...
    XrResult xrCreateDebugUtilsMessengerEXT( XrInstance instance, const XrDebugUtilsMessengerCreateInfoEXT* createInfo, XrDebugUtilsMessengerEXT* messenger) const {
    ...
    XrResult xrSubmitDebugUtilsMessageEXT( XrInstance instance, XrDebugUtilsMessageSeverityFlagsEXT messageSeverity, XrDebugUtilsMessageTypeFlagsEXT messageTypes, const XrDebugUtilsMessengerCallbackDataEXT* callbackData) const {
    ...
    XrResult xrSetInputDeviceActiveEXT( XrSession session, XrPath interactionProfile, XrPath topLevelPath, XrBool32 isActive) const {
    ...
    XrResult xrSetInputDeviceStateBoolEXT( XrSession session, XrPath topLevelPath, XrPath inputSourcePath, XrBool32 state) const {
    ...
    XrResult xrSetInputDeviceStateFloatEXT( XrSession session, XrPath topLevelPath, XrPath inputSourcePath, float state) const {
    ...
    XrResult xrSetInputDeviceStateVector2fEXT( XrSession session, XrPath topLevelPath, XrPath inputSourcePath, XrVector2f state) const {
    ...
    XrResult xrSetInputDeviceLocationEXT( XrSession session, XrPath topLevelPath, XrPath inputSourcePath, XrSpace space, XrPosef pose) const {
    ...
    XrResult xrCreateSpatialGraphNodeSpaceMSFT( XrSession session, const XrSpatialGraphNodeSpaceCreateInfoMSFT* createInfo, XrSpace* space) const {
    ...
    XrResult xrCreateHandTrackerEXT( XrSession session, const XrHandTrackerCreateInfoEXT* createInfo, XrHandTrackerEXT* handTracker) const {
    ...
    XrResult xrLocateHandJointsEXT( XrHandTrackerEXT handTracker, const XrHandJointsLocateInfoEXT* locateInfo, XrHandJointLocationsEXT* locations) const {
    ...
    XrResult xrCreateHandMeshSpaceMSFT( XrHandTrackerEXT handTracker, const XrHandMeshSpaceCreateInfoMSFT* createInfo, XrSpace* space) const {
    ...
    XrResult xrUpdateHandMeshMSFT( XrHandTrackerEXT handTracker, const XrHandMeshUpdateInfoMSFT* updateInfo, XrHandMeshMSFT* handMesh) const {
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getInstanceProcAddr (
    const char* name, PFN_xrVoidFunction* function, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetInstanceProcAddr(this->get(), name, function) );
...
OPENXR_HPP_INLINE typename ResultValueType<std::vector<ApiLayerProperties, Allocator>>::type enumerateApiLayerProperties (
    Dispatch&& d)  {
    // Two-call idiom
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<ExtensionProperties, Allocator>>::type enumerateInstanceExtensionProperties (
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroyInstance(this->get()) );
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::resultToString (
    Result value, char buffer[XR_MAX_RESULT_STRING_SIZE], Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrResultToString(this->get(), OPENXR_HPP_NAMESPACE::get(value), buffer) );
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::structureTypeToString (
    StructureType value, char buffer[XR_MAX_STRUCTURE_NAME_SIZE], Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrStructureTypeToString(this->get(), OPENXR_HPP_NAMESPACE::get(value), buffer) );
...
OPENXR_HPP_INLINE Result Instance::getSystem (
    const SystemGetInfo& getInfo, const SystemId& systemId, Dispatch&& d) const {
...
OPENXR_HPP_INLINE Result Instance::getSystemProperties (
    const SystemId& systemId, SystemProperties& properties, Dispatch&& d) const {
...
OPENXR_HPP_INLINE Result Instance::enumerateEnvironmentBlendModes (
    const SystemId& systemId, ViewConfigurationType viewConfigurationType, uint32_t environmentBlendModeCapacityInput, uint32_t* environmentBlendModeCountOutput, XrEnvironmentBlendMode* environmentBlendModes, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrEnumerateEnvironmentBlendModes(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), environmentBlendModeCapacityInput, environmentBlendModeCountOutput, environmentBlendModes) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<EnvironmentBlendMode, Allocator>>::type Instance::enumerateEnvironmentBlendModes (
    const SystemId& systemId, ViewConfigurationType viewConfigurationType, Dispatch&& d) const {
    // Two-call idiom
    ...
    Result result = static_cast<Result>( d.xrEnumerateEnvironmentBlendModes(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), environmentBlendModeCapacityInput, &environmentBlendModeCountOutput, nullptr) );
    ...
    do {
        ...
        result = static_cast<Result>( d.xrEnumerateEnvironmentBlendModes(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), environmentBlendModeCapacityInput, &environmentBlendModeCountOutput, reinterpret_cast<XrEnvironmentBlendMode*>(environmentBlendModes.data())) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroySession(this->get()) );
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<ReferenceSpaceType, Allocator>>::type Session::enumerateReferenceSpaces (
    Dispatch&& d) const {
    // Two-call idiom
...
OPENXR_HPP_INLINE Result Session::getReferenceSpaceBoundsRect (
    ...
    Result result = static_cast<Result>( d.xrGetReferenceSpaceBoundsRect(this->get(), OPENXR_HPP_NAMESPACE::get(referenceSpaceType), OPENXR_HPP_NAMESPACE::put(bounds)) );
    return result;
}
#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
...
OPENXR_HPP_INLINE Result Space::locateSpace (
    Space baseSpace, const Time& time, SpaceLocation& location, Dispatch&& d) const {
...
OPENXR_HPP_INLINE typename ResultValueType<SpaceLocation>::type Space::locateSpace (
    Space baseSpace, const Time& time, Dispatch&& d) const {
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Space::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroySpace(this->get()) );
...
OPENXR_HPP_INLINE Result Instance::enumerateViewConfigurations (
    const SystemId& systemId, uint32_t viewConfigurationTypeCapacityInput, uint32_t* viewConfigurationTypeCountOutput, XrViewConfigurationType* viewConfigurationTypes, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrEnumerateViewConfigurations(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), viewConfigurationTypeCapacityInput, viewConfigurationTypeCountOutput, viewConfigurationTypes) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<ViewConfigurationType, Allocator>>::type Instance::enumerateViewConfigurations (
    ...
    Result result = static_cast<Result>( d.xrEnumerateViewConfigurations(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), viewConfigurationTypeCapacityInput, &viewConfigurationTypeCountOutput, nullptr) );
    ...
    do {
        ...
        result = static_cast<Result>( d.xrEnumerateViewConfigurations(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), viewConfigurationTypeCapacityInput, &viewConfigurationTypeCountOutput, reinterpret_cast<XrViewConfigurationType*>(viewConfigurationTypes.data())) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
OPENXR_HPP_INLINE Result Instance::getViewConfigurationProperties (
    const SystemId& systemId, ViewConfigurationType viewConfigurationType, ViewConfigurationProperties& configurationProperties, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetViewConfigurationProperties(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), OPENXR_HPP_NAMESPACE::put(configurationProperties)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
OPENXR_HPP_INLINE typename ResultValueType<ViewConfigurationProperties>::type Instance::getViewConfigurationProperties (
    ...
    Result result = static_cast<Result>( d.xrGetViewConfigurationProperties(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), OPENXR_HPP_NAMESPACE::put(returnVal)) );
...
OPENXR_HPP_INLINE Result Instance::enumerateViewConfigurationViews (
    const SystemId& systemId, ViewConfigurationType viewConfigurationType, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrViewConfigurationView* views, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrEnumerateViewConfigurationViews(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewCapacityInput, viewCountOutput, views) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<ViewConfigurationView, Allocator>>::type Instance::enumerateViewConfigurationViews (
    ...
    Result result = static_cast<Result>( d.xrEnumerateViewConfigurationViews(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewCapacityInput, &viewCountOutput, nullptr) );
    ...
    do {
        ...
        result = static_cast<Result>( d.xrEnumerateViewConfigurationViews(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewCapacityInput, &viewCountOutput, reinterpret_cast<XrViewConfigurationView*>(views.data())) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<int64_t, Allocator>>::type Session::enumerateSwapchainFormats (
    Dispatch&& d) const {
    // Two-call idiom
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Swapchain::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroySwapchain(this->get()) );
...
OPENXR_HPP_INLINE typename ResultValueType<std::vector<ResultItemType, Allocator>>::type Swapchain::enumerateSwapchainImages (
    Dispatch&& d) const {
    // Two-call idiom
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::endSession (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrEndSession(this->get()) );
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::requestExitSession (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrRequestExitSession(this->get()) );
...
OPENXR_HPP_INLINE Result Session::locateViews (
    ...
    Result result = static_cast<Result>( d.xrLocateViews(this->get(), OPENXR_HPP_NAMESPACE::get(viewLocateInfo), viewState, viewCapacityInput, viewCountOutput, views) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<View, Allocator>>::type Session::locateViews (
    ...
    Result result = static_cast<Result>( d.xrLocateViews(this->get(), OPENXR_HPP_NAMESPACE::get(viewLocateInfo), viewState, viewCapacityInput, &viewCountOutput, nullptr) );
    if (!unqualifiedSuccess(result) || viewCountOutput == 0) {
    ...
    do {
        views.resize(viewCountOutput);
        viewCapacityInput = static_cast<uint32_t>(views.size());
        result = static_cast<Result>( d.xrLocateViews(this->get(), OPENXR_HPP_NAMESPACE::get(viewLocateInfo), viewState, viewCapacityInput, &viewCountOutput, reinterpret_cast<XrView*>(views.data())) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(viewCountOutput <= views.size());
        views.resize(viewCountOutput);
...
OPENXR_HPP_INLINE Result Instance::stringToPath (
    const char* pathString, const Path& path, Dispatch&& d) const {
...
OPENXR_HPP_INLINE Result Instance::pathToString (
    const Path& path, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d) const {
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<string_with_allocator<Allocator>>::type Instance::pathToString (
    const Path& path, Dispatch&& d) const {
    // Two-call idiom
    ...
    do {
        ...
        result = static_cast<Result>( d.xrPathToString(this->get(), OPENXR_HPP_NAMESPACE::get(path), bufferCapacityInput, &bufferCountOutput, reinterpret_cast<char*>(buffer.data())) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type ActionSet::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroyActionSet(this->get()) );
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Action::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroyAction(this->get()) );
...
OPENXR_HPP_INLINE Result Session::getCurrentInteractionProfile (
    const Path& topLevelUserPath, InteractionProfileState& interactionProfile, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetCurrentInteractionProfile(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelUserPath), OPENXR_HPP_NAMESPACE::put(interactionProfile)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
OPENXR_HPP_INLINE typename ResultValueType<InteractionProfileState>::type Session::getCurrentInteractionProfile (
    const Path& topLevelUserPath, Dispatch&& d) const {
    InteractionProfileState returnVal;
    Result result = static_cast<Result>( d.xrGetCurrentInteractionProfile(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelUserPath), OPENXR_HPP_NAMESPACE::put(returnVal)) );
...
OPENXR_HPP_INLINE Result Session::enumerateBoundSourcesForAction (
    const BoundSourcesForActionEnumerateInfo& enumerateInfo, uint32_t sourceCapacityInput, uint32_t* sourceCountOutput, const Path& sources, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrEnumerateBoundSourcesForAction(this->get(), OPENXR_HPP_NAMESPACE::get(enumerateInfo), sourceCapacityInput, sourceCountOutput, OPENXR_HPP_NAMESPACE::get(sources)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<Path, Allocator>>::type Session::enumerateBoundSourcesForAction (
    ...
    Result result = static_cast<Result>( d.xrEnumerateBoundSourcesForAction(this->get(), OPENXR_HPP_NAMESPACE::get(enumerateInfo), sourceCapacityInput, &sourceCountOutput, nullptr) );
    ...
    do {
        ...
        result = static_cast<Result>( d.xrEnumerateBoundSourcesForAction(this->get(), OPENXR_HPP_NAMESPACE::get(enumerateInfo), sourceCapacityInput, &sourceCountOutput, reinterpret_cast<XrPath*>(sources.data())) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
OPENXR_HPP_INLINE Result Session::getInputSourceLocalizedName (
    ...
    Result result = static_cast<Result>( d.xrGetInputSourceLocalizedName(this->get(), OPENXR_HPP_NAMESPACE::get(getInfo), bufferCapacityInput, bufferCountOutput, buffer) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<string_with_allocator<Allocator>>::type Session::getInputSourceLocalizedName (
    ...
    std::basic_string<char, std::char_traits<char>, Allocator> str{{}};
    Result result = static_cast<Result>( d.xrGetInputSourceLocalizedName(this->get(), OPENXR_HPP_NAMESPACE::get(getInfo), bufferCapacityInput, &bufferCountOutput, nullptr) );
    if (!unqualifiedSuccess(result) || bufferCountOutput == 0) {
    ...
    do {
        buffer.resize(bufferCountOutput);
        bufferCapacityInput = static_cast<uint32_t>(buffer.size());
        result = static_cast<Result>( d.xrGetInputSourceLocalizedName(this->get(), OPENXR_HPP_NAMESPACE::get(getInfo), bufferCapacityInput, &bufferCountOutput, reinterpret_cast<char*>(buffer.data())) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(bufferCountOutput <= buffer.size());
        buffer.resize(bufferCountOutput);
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::setAndroidApplicationThreadKHR (
    AndroidThreadTypeKHR threadType, uint32_t threadId, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetAndroidApplicationThreadKHR(this->get(), OPENXR_HPP_NAMESPACE::get(threadType), threadId) );
...
OPENXR_HPP_INLINE Result Instance::getOpenGLGraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsOpenGLKHR& graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetOpenGLGraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(graphicsRequirements)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
OPENXR_HPP_INLINE typename ResultValueType<GraphicsRequirementsOpenGLKHR>::type Instance::getOpenGLGraphicsRequirementsKHR (
    ...
    Result result = static_cast<Result>( d.xrGetOpenGLGraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(returnVal)) );
...
OPENXR_HPP_INLINE Result Instance::getOpenGLESGraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsOpenGLESKHR& graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetOpenGLESGraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(graphicsRequirements)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
OPENXR_HPP_INLINE typename ResultValueType<GraphicsRequirementsOpenGLESKHR>::type Instance::getOpenGLESGraphicsRequirementsKHR (
    ...
    Result result = static_cast<Result>( d.xrGetOpenGLESGraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(returnVal)) );
...
OPENXR_HPP_INLINE Result Instance::getVulkanInstanceExtensionsKHR (
    const SystemId& systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetVulkanInstanceExtensionsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), bufferCapacityInput, bufferCountOutput, buffer) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<string_with_allocator<Allocator>>::type Instance::getVulkanInstanceExtensionsKHR (
    const SystemId& systemId, Dispatch&& d) const {
    // Two-call idiom
    std::vector<char, Allocator> buffer;
            uint32_t bufferCountOutput = 0;
    ...
    std::basic_string<char, std::char_traits<char>, Allocator> str{{}};
    Result result = static_cast<Result>( d.xrGetVulkanInstanceExtensionsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), bufferCapacityInput, &bufferCountOutput, nullptr) );
    if (!unqualifiedSuccess(result) || bufferCountOutput == 0) {
    ...
    do {
        buffer.resize(bufferCountOutput);
        bufferCapacityInput = static_cast<uint32_t>(buffer.size());
        result = static_cast<Result>( d.xrGetVulkanInstanceExtensionsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), bufferCapacityInput, &bufferCountOutput, reinterpret_cast<char*>(buffer.data())) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(bufferCountOutput <= buffer.size());
        buffer.resize(bufferCountOutput);
...
OPENXR_HPP_INLINE Result Instance::getVulkanDeviceExtensionsKHR (
    const SystemId& systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetVulkanDeviceExtensionsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), bufferCapacityInput, bufferCountOutput, buffer) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<string_with_allocator<Allocator>>::type Instance::getVulkanDeviceExtensionsKHR (
    const SystemId& systemId, Dispatch&& d) const {
    // Two-call idiom
    std::vector<char, Allocator> buffer;
            uint32_t bufferCountOutput = 0;
    ...
    std::basic_string<char, std::char_traits<char>, Allocator> str{{}};
    Result result = static_cast<Result>( d.xrGetVulkanDeviceExtensionsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), bufferCapacityInput, &bufferCountOutput, nullptr) );
    if (!unqualifiedSuccess(result) || bufferCountOutput == 0) {
    ...
    do {
        buffer.resize(bufferCountOutput);
        bufferCapacityInput = static_cast<uint32_t>(buffer.size());
        result = static_cast<Result>( d.xrGetVulkanDeviceExtensionsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), bufferCapacityInput, &bufferCountOutput, reinterpret_cast<char*>(buffer.data())) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(bufferCountOutput <= buffer.size());
        buffer.resize(bufferCountOutput);
...
OPENXR_HPP_INLINE Result Instance::getVulkanGraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsVulkanKHR& graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetVulkanGraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(graphicsRequirements)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
OPENXR_HPP_INLINE typename ResultValueType<GraphicsRequirementsVulkanKHR>::type Instance::getVulkanGraphicsRequirementsKHR (
    ...
    Result result = static_cast<Result>( d.xrGetVulkanGraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(returnVal)) );
...
OPENXR_HPP_INLINE Result Instance::getD3D11GraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsD3D11KHR& graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetD3D11GraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(graphicsRequirements)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
OPENXR_HPP_INLINE typename ResultValueType<GraphicsRequirementsD3D11KHR>::type Instance::getD3D11GraphicsRequirementsKHR (
    ...
    Result result = static_cast<Result>( d.xrGetD3D11GraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(returnVal)) );
...
OPENXR_HPP_INLINE Result Instance::getD3D12GraphicsRequirementsKHR (
    const SystemId& systemId, GraphicsRequirementsD3D12KHR& graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetD3D12GraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(graphicsRequirements)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
OPENXR_HPP_INLINE typename ResultValueType<GraphicsRequirementsD3D12KHR>::type Instance::getD3D12GraphicsRequirementsKHR (
    ...
    Result result = static_cast<Result>( d.xrGetD3D12GraphicsRequirementsKHR(this->get(), OPENXR_HPP_NAMESPACE::get(systemId), OPENXR_HPP_NAMESPACE::put(returnVal)) );
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::perfSettingsSetPerformanceLevelEXT (
    PerfSettingsDomainEXT domain, PerfSettingsLevelEXT level, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrPerfSettingsSetPerformanceLevelEXT(this->get(), OPENXR_HPP_NAMESPACE::get(domain), OPENXR_HPP_NAMESPACE::get(level)) );
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::thermalGetTemperatureTrendEXT (
    PerfSettingsDomainEXT domain, PerfSettingsNotificationLevelEXT& notificationLevel, float* tempHeadroom, float* tempSlope, Dispatch&& d) const {
    XrPerfSettingsNotificationLevelEXT notificationLevel_tmp;
    Result result = static_cast<Result>( d.xrThermalGetTemperatureTrendEXT(this->get(), OPENXR_HPP_NAMESPACE::get(domain), notificationLevel_tmp, tempHeadroom, tempSlope) );
    notificationLevel = static_cast<PerfSettingsNotificationLevelEXT>(notificationLevel_tmp);
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type DebugUtilsMessengerEXT::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroyDebugUtilsMessengerEXT(this->get()) );
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::sessionEndDebugUtilsLabelRegionEXT (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSessionEndDebugUtilsLabelRegionEXT(this->get()) );
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type SpatialAnchorMSFT::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroySpatialAnchorMSFT(this->get()) );
...
OPENXR_HPP_INLINE Result Session::setInputDeviceActiveEXT (
    const Path& interactionProfile, const Path& topLevelPath, XrBool32 isActive, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceActiveEXT(this->get(), OPENXR_HPP_NAMESPACE::get(interactionProfile), OPENXR_HPP_NAMESPACE::get(topLevelPath), isActive) );
    return result;
}
#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::setInputDeviceActiveEXT (
    const Path& interactionProfile, const Path& topLevelPath, XrBool32 isActive, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceActiveEXT(this->get(), OPENXR_HPP_NAMESPACE::get(interactionProfile), OPENXR_HPP_NAMESPACE::get(topLevelPath), isActive) );
    return impl::createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::setInputDeviceActiveEXT");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::setInputDeviceStateBoolEXT (
    const Path& topLevelPath, const Path& inputSourcePath, XrBool32 state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceStateBoolEXT(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelPath), OPENXR_HPP_NAMESPACE::get(inputSourcePath), state) );
    return result;
}
#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::setInputDeviceStateBoolEXT (
    const Path& topLevelPath, const Path& inputSourcePath, XrBool32 state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceStateBoolEXT(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelPath), OPENXR_HPP_NAMESPACE::get(inputSourcePath), state) );
    return impl::createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::setInputDeviceStateBoolEXT");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::setInputDeviceStateFloatEXT (
    const Path& topLevelPath, const Path& inputSourcePath, float state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceStateFloatEXT(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelPath), OPENXR_HPP_NAMESPACE::get(inputSourcePath), state) );
    return result;
}
#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::setInputDeviceStateFloatEXT (
    const Path& topLevelPath, const Path& inputSourcePath, float state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceStateFloatEXT(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelPath), OPENXR_HPP_NAMESPACE::get(inputSourcePath), state) );
    return impl::createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::setInputDeviceStateFloatEXT");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::setInputDeviceStateVector2fEXT (
    const Path& topLevelPath, const Path& inputSourcePath, XrVector2f state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceStateVector2fEXT(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelPath), OPENXR_HPP_NAMESPACE::get(inputSourcePath), state) );
    return result;
}
#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::setInputDeviceStateVector2fEXT (
    const Path& topLevelPath, const Path& inputSourcePath, XrVector2f state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceStateVector2fEXT(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelPath), OPENXR_HPP_NAMESPACE::get(inputSourcePath), state) );
    return impl::createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::setInputDeviceStateVector2fEXT");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::setInputDeviceLocationEXT (
    const Path& topLevelPath, const Path& inputSourcePath, Space space, XrPosef pose, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceLocationEXT(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelPath), OPENXR_HPP_NAMESPACE::get(inputSourcePath), space.get(), pose) );
    return result;
}
#else /* OPENXR_HPP_DISABLE_ENHANCED_MODE */
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type Session::setInputDeviceLocationEXT (
    const Path& topLevelPath, const Path& inputSourcePath, Space space, XrPosef pose, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetInputDeviceLocationEXT(this->get(), OPENXR_HPP_NAMESPACE::get(topLevelPath), OPENXR_HPP_NAMESPACE::get(inputSourcePath), space.get(), pose) );
    return impl::createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::setInputDeviceLocationEXT");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::createSpatialGraphNodeSpaceMSFT (
    const SpatialGraphNodeSpaceCreateInfoMSFT& createInfo, Space& space, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrCreateSpatialGraphNodeSpaceMSFT(this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), space.put()) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
template <typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<Space>::type Session::createSpatialGraphNodeSpaceMSFT (
    const SpatialGraphNodeSpaceCreateInfoMSFT& createInfo, Dispatch&& d) const {
    Space handle;
    Result result = static_cast<Result>( d.xrCreateSpatialGraphNodeSpaceMSFT(this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), handle.put()) );
    return impl::createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Session::createSpatialGraphNodeSpaceMSFT");
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE

template <typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>>::type Session::createSpatialGraphNodeSpaceUniqueMSFT (
    const SpatialGraphNodeSpaceCreateInfoMSFT& createInfo, Dispatch&& d) const {
    Space handle;
    Result result = static_cast<Result>( d.xrCreateSpatialGraphNodeSpaceMSFT(this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return impl::createResultValue<Space,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Session::createSpatialGraphNodeSpaceUniqueMSFT");
}
...
OPENXR_HPP_INLINE Result Session::createHandTrackerEXT (
    const HandTrackerCreateInfoEXT& createInfo, HandTrackerEXT& handTracker, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrCreateHandTrackerEXT(this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), handTracker.put()) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
template <typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<HandTrackerEXT>::type Session::createHandTrackerEXT (
    const HandTrackerCreateInfoEXT& createInfo, Dispatch&& d) const {
    HandTrackerEXT handle;
    Result result = static_cast<Result>( d.xrCreateHandTrackerEXT(this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), handle.put()) );
    return impl::createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Session::createHandTrackerEXT");
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE

template <typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<UniqueHandle<HandTrackerEXT, impl::RemoveRefConst<Dispatch>>>::type Session::createHandTrackerUniqueEXT (
    const HandTrackerCreateInfoEXT& createInfo, Dispatch&& d) const {
    HandTrackerEXT handle;
    Result result = static_cast<Result>( d.xrCreateHandTrackerEXT(this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return impl::createResultValue<HandTrackerEXT,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Session::createHandTrackerUniqueEXT");
}
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValueType<void>::type HandTrackerEXT::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroyHandTrackerEXT(this->get()) );
    return impl::createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::HandTrackerEXT::destroy");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result HandTrackerEXT::locateHandJointsEXT (
    const HandJointsLocateInfoEXT& locateInfo, HandJointLocationsEXT& locations, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrLocateHandJointsEXT(this->get(), OPENXR_HPP_NAMESPACE::get(locateInfo), OPENXR_HPP_NAMESPACE::put(locations)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
template <typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<HandJointLocationsEXT>::type HandTrackerEXT::locateHandJointsEXT (
    const HandJointsLocateInfoEXT& locateInfo, Dispatch&& d) const {
    HandJointLocationsEXT returnVal;
    Result result = static_cast<Result>( d.xrLocateHandJointsEXT(this->get(), OPENXR_HPP_NAMESPACE::get(locateInfo), OPENXR_HPP_NAMESPACE::put(returnVal)) );
    return impl::createResultValue(result,returnVal, OPENXR_HPP_NAMESPACE_STRING "::HandTrackerEXT::locateHandJointsEXT");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result HandTrackerEXT::createHandMeshSpaceMSFT (
    const HandMeshSpaceCreateInfoMSFT& createInfo, Space& space, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrCreateHandMeshSpaceMSFT(this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), space.put()) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
template <typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<Space>::type HandTrackerEXT::createHandMeshSpaceMSFT (
    const HandMeshSpaceCreateInfoMSFT& createInfo, Dispatch&& d) const {
    Space handle;
    Result result = static_cast<Result>( d.xrCreateHandMeshSpaceMSFT(this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), handle.put()) );
    return impl::createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::HandTrackerEXT::createHandMeshSpaceMSFT");
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE

template <typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>>::type HandTrackerEXT::createHandMeshSpaceUniqueMSFT (
    const HandMeshSpaceCreateInfoMSFT& createInfo, Dispatch&& d) const {
    Space handle;
    Result result = static_cast<Result>( d.xrCreateHandMeshSpaceMSFT(this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return impl::createResultValue<Space,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::HandTrackerEXT::createHandMeshSpaceUniqueMSFT");
}
...
OPENXR_HPP_INLINE Result HandTrackerEXT::updateHandMeshMSFT (
    const HandMeshUpdateInfoMSFT& updateInfo, HandMeshMSFT& handMesh, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrUpdateHandMeshMSFT(this->get(), OPENXR_HPP_NAMESPACE::get(updateInfo), OPENXR_HPP_NAMESPACE::put(handMesh)) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
...
template <typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<HandMeshMSFT>::type HandTrackerEXT::updateHandMeshMSFT (
    const HandMeshUpdateInfoMSFT& updateInfo, Dispatch&& d) const {
    HandMeshMSFT returnVal;
    Result result = static_cast<Result>( d.xrUpdateHandMeshMSFT(this->get(), OPENXR_HPP_NAMESPACE::get(updateInfo), OPENXR_HPP_NAMESPACE::put(returnVal)) );
    return impl::createResultValue(result,returnVal, OPENXR_HPP_NAMESPACE_STRING "::HandTrackerEXT::updateHandMeshMSFT");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
